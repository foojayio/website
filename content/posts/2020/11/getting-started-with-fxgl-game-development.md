...
<pre class="EnlighterJSRAW" data-enlighter-language="java">import static com.almasb.fxgl.dsl.FXGL.getAppHeight;
...
import javafx.util.Duration;</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="java">public class GeoWarsApp extends GameApplication {
...
<pre class="EnlighterJSRAW" data-enlighter-language="java">public enum EntityType {
    PLAYER, BULLET, ENEMY
}</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="java">import static com.almasb.fxgl.dsl.FXGL.entityBuilder;
...
<pre class="EnlighterJSRAW" data-enlighter-language="java">public class GeoWarsFactory implements EntityFactory {
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic">public class GeoWarsFactory implements EntityFactory {
