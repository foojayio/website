...
### 1. Join the OpenJDK Mailing List {#h3-0-1-join-the-openjdk-mailing-list}

The simplest way to contribute to OpenJDK development is to subscribe to one of the OpenJDK mailing lists, for example [JDK-Dev](http://jdk-dev@openjdk.java.net "JDK-Dev"). Here you can see what's being discussed and worked on for the upcoming version of the JDK.
...
### 2. Suggest a New JEP {#h3-1-2-suggest-a-new-jep}

If your company is deeply integrated into Java but some new Java development would increase your ability to utilize Java to meet your objectives, it's always possible to suggest a new enhancement to Java, that is, a new [Java Enhancement Proposal](https://openjdk.java.net/jeps/1 "Java Enhancement Proposal") (JEP).
...
### 3.Test and Find Bugs in the Latest Developmental OpenJDK {#h3-2-3-test-and-find-bugs-in-the-latest-developmental-openjdk}

Source code for the latest developmental version of OpenJDK is available on [Github](https://github.com/openjdk/jdk "Github"). A problem with large open source projects is that the companies supporting the development of the next version have limited resources for doing effective quality assurance analysis.
...
### 4. Contribute a Fix to a Bug Listed in the OpenJDK JIRA {#h3-3-4-contribute-a-fix-to-a-bug-listed-in-the-openjdk-jira}

You can go to the [JDK Bug System](https://bugs.openjdk.java.net/secure/Dashboard.jspa "JDK Bug System") and see which problems people are working on, which problems have been identified, and if you notice that a problem you discovered is not yet listed in the JIRA, you can add it.
...
### 5. Contribute New Code in Support of a JEP {#h3-4-5-contribute-new-code-in-support-of-a-jep}
...
### 6. Publicize New OpenJDK Releases {#h3-5-6-publicize-new-openjdk-releases}
