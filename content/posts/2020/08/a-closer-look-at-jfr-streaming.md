...
An Introduction to JFR Streaming {#h2-0-an-introduction-to-jfr-streaming}
-------------------------------------------------------------------------
...
Where to use streaming {#h2-1-where-to-use-streaming}
-----------------------------------------------------
...
Where Not to Use Streaming {#h2-2-where-not-to-use-streaming}
-------------------------------------------------------------
...
Benchmarks of Using JFR Streaming Wrongly {#h2-3-benchmarks-of-using-jfr-streaming-wrongly}
-------------------------------------------------------------------------------------------
