...
We're happy to announce that we're hosting Chris Newland's [VMOptionsExplorer](http://javaalmanac.io) [right here on foojay](https://foojay.io/almanac/jdk-8/), providing all details per release on Java command line switches.
![](/images/posts/2020/08/interview-java-command-line-switches/Screenshot-2020-08-29-at-23.09.05-1024x514.png)
...
![](/images/posts/2020/08/interview-java-command-line-switches/Screenshot-2020-08-29-at-23.09.57-1024x485.png)

Go here to take a look, yourself: <https://foojay.io/command-line-arguments/openjdk-11>.

Let's meet Chris, here's a quick interview with him about his Java command line switches integrated into foojay!  

<figure class="alignleft size-large is-resized">
 <img decoding="async" src="/images/posts/2020/08/interview-java-command-line-switches/0-2.jpeg" alt="" class="wp-image-32784" width="146" height="146">
</figure>
