...
authors:
  - "don-raab"
image: "/images/posts/2020/12/immutable-collections-in-java-with-sealed-types/foojay-don-1-1-469x510.png"
categories:
  - "Sealed Classes"
  - "Tutorials"
tags:
...
<img fetchpriority="high" decoding="async" aria-describedby="caption-attachment-36538" class="size-medium wp-image-36538" src="/images/posts/2020/12/immutable-collections-in-java-with-sealed-types/foojay-don-1-1-469x510.png" alt="" width="469" height="510">
...
### What is contractual immutability? {#7250}
...
### What is structural immutability? {#a085}
...
### What is verifiable immutability? {#bb8e}
...
### A Perfect Use Case for Sealed Types in Java {#c3c9}
...
![](/images/posts/2020/12/immutable-collections-in-java-with-sealed-types/foojay-don-2-700x54.png) sealed interface ImmutableCollection

Similarly, we can restrict the implementations of `ImmutableList`.{#1867}
![](/images/posts/2020/12/immutable-collections-in-java-with-sealed-types/foojay-don-3.png) sealed interface ImmutableList

The ImmutableEmptyList implementation of ImmutableList is then declared as final.
![](/images/posts/2020/12/immutable-collections-in-java-with-sealed-types/foojay-don-4.png) class ImmutableEmptyList
...
### The Deck of Cards Kata: Custom Collections {#88aa}
...
![](/images/posts/2020/12/immutable-collections-in-java-with-sealed-types/foojay-don-5-1024x592.png) A Custom Collections framework in the Deck of Cards Kata   
...
### A vision for the Future of Java Collections {#da0f}
