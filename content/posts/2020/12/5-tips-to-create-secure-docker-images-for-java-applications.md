...
1. Choose the right Docker base image for your Java application {#h2-0-1-choose-the-right-docker-base-image-for-your-java-application}
--------------------------------------------------------------------------------------------------------------------------------------
...
![](/images/posts/2020/12/5-tips-to-create-secure-docker-images-for-java-applications/adoptopenjdk-graph.png)
...
2. Use a JRE, not a JDK {#h2-1-2-use-a-jre-not-a-jdk}
-----------------------------------------------------
...
3. Don't run your Docker container as root {#h2-2-3-don-t-run-your-docker-container-as-root}
--------------------------------------------------------------------------------------------
...
4. Scan your Docker image and Java application during development {#h2-3-4-scan-your-docker-image-and-java-application-during-development}
------------------------------------------------------------------------------------------------------------------------------------------
...
5. Build to rebuild {#h2-4-5-build-to-rebuild}
----------------------------------------------
