...
Fourthly, **inline** the original getter everywhere. Everyone will end up calling `getMemberCardOpt()`.

Finally, **rename** the getter to the default name (removing the `Opt` suffix)
