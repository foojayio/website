...
![Image 1.: Common ForkJoin thread pool is shared with Virtual Threads and even custom Factory and each virtual thread belongs to the “VirtualThread” group.](/images/posts/2022/04/thinking-about-massive-throughput-meet-virtual-threads/image_1-700x273.png) Image 1.: Common ForkJoin thread pool is shared with Virtual Threads and even custom Factory and each virtual thread belongs to the "VirtualThread" group.
...
![Image 2.: Upcoming Java Flight Recorder Events for Virtual Threads](/images/posts/2022/04/thinking-about-massive-throughput-meet-virtual-threads/image_2-614x510.png) Image 2.: Upcoming Java Flight Recorder Events for Virtual Threads
...
![Image 3.: ComputableTaskEvent emitted by the task. It shows the Virtual Threads usage. Virtual Threads are served by the factory (Example 5.)](/images/posts/2022/04/thinking-about-massive-throughput-meet-virtual-threads/image_3-700x229.png) Image 3.: ComputableTaskEvent emitted by the task. It shows the Virtual Threads usage. Virtual Threads are served by the factory (Example 5.)
...
![Image 4.: Traditional “request-per-thread” approach showing its limitations compared to Image 3.](/images/posts/2022/04/thinking-about-massive-throughput-meet-virtual-threads/image_4-700x93.png) Image 4.: Traditional "request-per-thread" approach showing its limitations compared to Image 3.
