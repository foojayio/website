...
Just enough dependency management in Python {#h2-0-just-enough-dependency-management-in-python}
-----------------------------------------------------------------------------------------------
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="dracula">click==8.1.3
Flask==2.2.2
itsdangerous==2.1.2
Jinja2==3.1.2
MarkupSafe==2.1.1
...
Dependencies and transitive dependencies {#h2-1-dependencies-and-transitive-dependencies}
-----------------------------------------------------------------------------------------
...
<pre class="EnlighterJSRAW" data-enlighter-language="shell">pip install deptree
deptree</pre>

The output is the following:

<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="dracula">Flask==2.2.2  # flask
...
<pre class="EnlighterJSRAW" data-enlighter-language="python" data-enlighter-theme="dracula">from setuptools import setup
...
Pip and transitive dependencies {#h2-2-pip-and-transitive-dependencies}
-----------------------------------------------------------------------
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic">libfoo==1.0.0
libbar==2.0</pre>
...
`pip-compile` to the rescue {#h2-3-pip-compile-to-the-rescue}
-------------------------------------------------------------
