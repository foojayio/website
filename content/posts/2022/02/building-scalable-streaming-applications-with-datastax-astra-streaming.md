...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_Yj9vaj0to8ZAf9NJ-1-1024x682.jpeg)
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_60OmPaLhWm_Fg96_.png) Figure 1: All the moving parts we'll need to build for this demo.
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_tqnoGodwfUrOeOFq.png) Figure 2: Accessing your organization settings.
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_U4RatnehQy_adGF1.png) Figure 3: Define the permissions for your custom role.
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_xC8xT6H5GZsyLp6R.png) Figure 4: Finishing the custom role definition.
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_m3ARgUdUAtt7NB3R.png) Figure 5: Generating a token.
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_BAvmShLukcYXe-8v.png) Figure 6: This information will never be shown to you again! Take this opportunity to download it.

Create the Astra Streaming components {#ab0a}
---------------------------------------------
...
Create the Astra Streaming tenant {#13a9}
-----------------------------------------
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_rsPw9QwfIaRBaIwf.png) Figure 7: The airport-events tenant dashboard.

Create the Astra Streaming namespace {#d151}
--------------------------------------------
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_0G4pEBJXCoivo2qL.png) Figure 8: Creating a namespace in Astra Streaming.

Set the namespace to `airport` and press the `create` button. It's just that easy!{#2dfd}

Create the Astra Streaming Topic {#adcc}
----------------------------------------
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0__15XVK-Ro0DQYFal.png) Figure 9: Creating a topic in the airport namespace.

You only need to specify the name of the topic, `object-location` as shown in the next image.{#59cc}
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_WtzPWE9x6_LLXdxr.png) Figure 10: Creating the object-location topic in the airport namespace.
...
Create the Astra DB sinks {#bce4}
---------------------------------
...
Create the object-location sink {#f4ce}
---------------------------------------
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_ncYrW0W6ZiHh5aGf.png) Figure 11: Creating the sink for the object_location table in our Astra DB.

In Step 1 of the wizard, select the fields as shown in the following image.{#7c92}
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_dspQGj73RA0JNFMx.png) Figure 12: Step 1-Create the object-location sink.

Be sure to select the `object-location` topic in Step 1 of the wizard.{#9549}
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_nHdITPVo-UhEMIIo.png) Figure 13: Step 2-Select the topic.
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_4oXutXoGzdW1DVCn.png) Figure 14: Step 3-Specify the database you want to use.
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_Vjx3tFExFTiN_9np.png) Figure 15: Notice the field mapping is automatically generated for you.

Press the `Create` button to create the sink.{#4659}

Create the objloc-history sink {#f364}
--------------------------------------
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_eEiMPNDdB2bfxP8_.png) Figure 16: Notice the field mapping is slightly different for this sink.
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_9gll9LTr_rtwEtyl.png) Figure 17: Viewing a topic schema.
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_mWsvrCJp4m66R19J.png) Figure 18: Events generated by the producer.
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_v43ESgR7axRQizjx.png) Figure 19: There should be a single record in your object_location table.
...
![](/images/posts/2022/02/building-scalable-streaming-applications-with-datastax-astra-streaming/0_HSvIZalTAr3p4rUF.png) Figure 20: Our object_location_history table's data.

Try it yourself! {#6ec2}
------------------------
