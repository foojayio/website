...
Already in the "[Pragmatic Programmer](https://pragprog.com/titles/tpp20/)", there was a clear reference to this in section 21:
> Use the Power of Command Shells+  
>
> Use the shell when graphical user interfaces don't cut it.

I would also like to refer to the book "[Productive Programmer](https://www.oreilly.com/library/view/the-productive-programmer/9780596519780/)" by NealFord:
...
| `GC.heap_dump filename=`                          | Create heapdump                          |
| `GC.heap_info`                                    | Overview of heap usage                   |
| `GC.run`                                          | Trigger Garbage Collection               |
| `Thread.print`                                    | Output thread dump                       |
| `JFR.start name= settings= delay=20s duration=2m` | Start JDK Flight Recorder Recording      |
| `JFR.dump name= filename=`                        | Create JFR Dump                          |
