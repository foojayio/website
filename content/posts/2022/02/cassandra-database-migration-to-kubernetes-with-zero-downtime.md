...
image: "/images/posts/2022/02/cassandra-database-migration-to-kubernetes-with-zero-downtime/image-1536x722-1.png"
categories:
  - "Apache Cassandra"
  - "Databases"
  - "DataStax"
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">$ nodetool status
...
UN  172.31.22.153  10.2 GiB  16      100.0%            d6488a81-be1c-4b07-9145-2aa32675282a  us-west-2a</pre>
...
![](/images/posts/2022/02/cassandra-database-migration-to-kubernetes-with-zero-downtime/image-1536x722-1-1024x481.png) Finding the VPC id
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group=""># Optional if you're using the default profile
...
export TF_VAR_region=us-west-2</pre>

We go to the env directory and initialize our Terraform files:

<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">cd env
terraform init</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">terraform plan
terraform apply
...
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">Apply complete! Resources: 50 added, 0 changed, 0 destroyed.
...
connect_cluster = "aws eks --region us-west-2 update-kubeconfig --name dev-adejanovski-migration-cluster-eks-cluster"</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">% aws eks --region us-west-2 update-kubeconfig --name dev-adejanovski-migration-cluster-eks-cluster

Updated context arn:aws:eks:us-west-2:3373455535488:cluster/dev-adejanovski-migration-cluster-eks-cluster in /Users/adejanovski/.kube/config</pre>
...
ip-10-0-3-239.us-west-2.compute.internal   Ready    &lt;none&gt;   5m   v1.20.4-eks-6b7464</pre>
...
![](/images/posts/2022/02/cassandra-database-migration-to-kubernetes-with-zero-downtime/image-1.png) Original Cassandra cluster
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">$ cqlsh $(hostname)
...
system_auth  system_schema       system_views   tlp_stress</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">cqlsh&gt; ALTER KEYSPACE &lt;keyspace_name&gt; WITH replication = {'class': 'NetworkTopologyStrategy', 'us-west-2': 3};</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">CqlSession session = CqlSession.builder()
...
![](/images/posts/2022/02/cassandra-database-migration-to-kubernetes-with-zero-downtime/image-2.png) Creating a K8ssandra deployment for the new datacenter
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">% helm install k8ssandra charts/k8ssandra -n k8ssandra --create-namespace -f ~/k8ssandra_demo/benchmarks.values.yaml
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">kubectl logs pod/adejanovski-migration-cluster-k8s-1-r1-sts-0 -c server-system-logger -n k8ssandra --follow</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">tail: can't open '/var/log/cassandra/system.log': No such file or directory</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">Datacenter: k8s-1
=================
Status=Up/Down
|/ State=Normal/Leaving/Joining/Moving
--  Address        Load       Tokens  Owns (effective)  Host ID                               Rack
...
![](/images/posts/2022/02/cassandra-database-migration-to-kubernetes-with-zero-downtime/image-3.png) Replicating data to the new datacenter by rebuilding
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">cqlsh&gt; ALTER KEYSPACE &lt;keyspace_name&gt; WITH replication = {'class': 'NetworkTopologyStrategy', 'us-west-2': '3', 'k8s-1': '3'};</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">% kubectl exec -it pod/adejanovski-migration-cluster-k8s-1-r1-sts-0 -c cassandra -n k8ssandra -- nodetool rebuild us-west-2</pre>
...
UN  172.31.22.153  10.32 GiB  16      100.0%            d6488a81-be1c-4b07-9145-2aa32675282a  us-west-2a</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">  auth:
    enabled: true
    superuser:
      secret: "superuser-password"
      username: "superuser-name"</pre>

### Switching traffic to the new datacenter {#h-switching-traffic-to-the-new-datacenter}

![](/images/posts/2022/02/cassandra-database-migration-to-kubernetes-with-zero-downtime/image-4.png) Redirecting client traffic to the new datacenter
...
![](/images/posts/2022/02/cassandra-database-migration-to-kubernetes-with-zero-downtime/image-5.png) Decommission the original datacenter

Once all the client apps/services have been restarted, we can alter our keyspaces to only replicate them on `k8s-1`:

<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">cqlsh&gt; ALTER KEYSPACE &lt;keyspace_name&gt; WITH replication = {'class': 'NetworkTopologyStrategy', 'k8s-1': '3'};</pre>

Then `ssh` into each of the Cassandra nodes in `us-west-2` and run the following command to decommission them:

<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="" data-enlighter-highlight="" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-title="" data-enlighter-group="">% nodetool decommission</pre>
...
UL  172.31.22.153  10.32 GiB  16      0.0%              d6488a81-be1c-4b07-9145-2aa32675282a  us-west-2a</pre>
...
UN  10.0.3.10  10.3 GiB  16      100.0%            c63b9b16-24fe-4232-b146-b7c2f450fcc6  r3
UN  10.0.2.66  10.3 GiB  16      100.0%            b1409a2e-cba1-482f-9ea6-c895bf296cd9  r2
UN  10.0.1.77  10.3 GiB  16      100.0%            78c53702-7a47-4629-a7bd-db41b1705bb8  r1</pre>
