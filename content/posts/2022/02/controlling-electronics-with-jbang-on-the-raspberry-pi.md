...
description: "JBang is a great way to create your first program to control electronic components connected to the Raspberry Pi's GPIO pins."
canonical: "https://pi4j.com/documentation/building/jbang/"
authors:
  - "frankdelporte"
image: "/images/posts/2022/02/controlling-electronics-with-jbang-on-the-raspberry-pi/jbang.png"
categories:
  - "Embedded"
  - "Java Beginner"
  - "JBang"
...
This video shows you all the steps described further in this article.
...
* Use the [Raspberry Pi Imager tool](https://www.raspberrypi.com/software/) to write the "Raspberry Pi OS (32-bit)" to this SD card
