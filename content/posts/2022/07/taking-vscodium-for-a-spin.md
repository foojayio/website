...
<img fetchpriority="high" decoding="async" class="aligncenter wp-image-56348 size-medium" src="/images/posts/2022/07/taking-vscodium-for-a-spin/python_extension-379x510.jpg" alt="Searching for Python extensions" width="379" height="510">
...
2. View each Git commit and navigate from one to the other. The default Git view is not enough. I installed [GitLens](https://marketplace.visualstudio.com/items?itemName=eamodio.gitlens), adding the feature to the Git view.![Git view with GitLens extension](/images/posts/2022/07/taking-vscodium-for-a-spin/gitlens-663x1024.jpg)
