...
![Conflicts dialog](conflicts-dialog.png)
...
![Yours Theirs labels in the Conflicts dialog](yours-theirs.png)
...
![Changes Commit Tool Window](changes-commit-tool-window.png)
...
![Final Conflict displayed](final-conflict.png)
...
![Right-click merge context menu](right-click-context-menu.png)
...
![Errors in the middle pane](errors-middle-pane-fixed.png)
