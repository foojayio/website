...
![](/images/posts/2022/09/baeldung-series-part-2-build-a-dashboard-with-cassandra-astra-and-cql-mapping-event-data/astra-secure-connect-1024x560.png)
...
![](/images/posts/2022/09/baeldung-series-part-2-build-a-dashboard-with-cassandra-astra-and-cql-mapping-event-data/astra-client-credentials-1024x610.png)
...
![](/images/posts/2022/09/baeldung-series-part-2-build-a-dashboard-with-cassandra-astra-and-cql-mapping-event-data/maps-api-key-768x482-1.png)

We then need to enable the Google Maps JavaScript API for this project. Search for this and enable this:
![](/images/posts/2022/09/baeldung-series-part-2-build-a-dashboard-with-cassandra-astra-and-cql-mapping-event-data/map-js-api-768x482-1.png)
...
![](/images/posts/2022/09/baeldung-series-part-2-build-a-dashboard-with-cassandra-astra-and-cql-mapping-event-data/maps-key-created-768x623-1.png)
...
&lt;head&gt;
  ...
  &lt;link href="https://cdn.jsdelivr.net/npm/<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f3919c9c878087819283b3c6ddc3ddc3de91968792c0">[email&nbsp;protected]</a>/dist/css/bootstrap.min.css" rel="stylesheet"
...
&lt;body&gt;
  ...
  &lt;script src="https://cdn.jsdelivr.net/npm/<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8defe2e2f9fef9ffecfdcdb8a3bda3bda0efe8f9ecbe">[email&nbsp;protected]</a>/dist/js/bootstrap.bundle.min.js"
...
![](/images/posts/2022/09/baeldung-series-part-2-build-a-dashboard-with-cassandra-astra-and-cql-mapping-event-data/avengers-map-1024x519-1.png)
