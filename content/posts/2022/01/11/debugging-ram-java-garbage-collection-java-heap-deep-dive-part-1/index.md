...
slug: "debugging-ram-java-garbage-collection-java-heap-deep-dive-part-1"
...
Garbage Collector Tradeoff {#h2-0-garbage-collector-tradeoff}
-------------------------------------------------------------
...
Not your Fathers Stop the World Mark Sweep {#h2-1-not-your-fathers-stop-the-world-mark-sweep}
---------------------------------------------------------------------------------------------
...
### Generational Garbage Collection {#h3-2-generational-garbage-collection}
...
### Concurrent vs. Parallel Garbage Collector {#h3-3-concurrent-vs-parallel-garbage-collector}
...
### Serial Collector {#h3-4-serial-collector}
...
### Parallel Collector aka Throughput Collector {#h3-5-parallel-collector-aka-throughput-collector}
...
### G1 Garbage Collector {#h3-6-g1-garbage-collector}
...
### Z Garbage Collector (ZGC) {#h3-7-z-garbage-collector-zgc}
...
Picking and Debugging a Garbage Collector {#h2-8-picking-and-debugging-a-garbage-collector}
-------------------------------------------------------------------------------------------
...
### Benchmarking/Measuring {#h3-9-benchmarking-measuring}
...
### Reducing RAM Usage {#h3-11-reducing-ram-usage}
...
### Generational Optimization {#h3-12-generational-optimization}
...
Metaspace, Permanent Generation, Stack Size, etc. {#h2-13-metaspace-permanent-generation-stack-size-etc}
--------------------------------------------------------------------------------------------------------
...
The Future at Valhalla {#h2-14-the-future-at-valhalla}
------------------------------------------------------
