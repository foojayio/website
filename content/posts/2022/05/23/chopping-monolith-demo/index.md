...
![User interface of an e-commerce shop demo](eshop.jpg)
...
![Initial pricing flow](initial-pricing.png)
...
![Chopped pricing flow](chopped-pricing.png)
...
![Apache APISIX helps with chopping the monolith](chop-monolith.jpg)
