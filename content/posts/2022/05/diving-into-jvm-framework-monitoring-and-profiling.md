...
![Image 1.: Considered scenario deployed into the Kubernetes cluster. Gatling node resides outside the cluster.](/images/posts/2022/05/diving-into-jvm-framework-monitoring-and-profiling/Image_1-700x355.png) **Figure 1.** : Simplified pods interactions during each of our tests
...
![Image 2.: Simple load scenario cycle used by each measured tests](/images/posts/2022/05/diving-into-jvm-framework-monitoring-and-profiling/Image_2-700x262.png) **Figure 2.** : Endpoints setup for each application
...
![Image 3.: generated report by Gatling](/images/posts/2022/05/diving-into-jvm-framework-monitoring-and-profiling/Image_3-552x510.png) **Figure 3.**: generated report by Gatling
...
<figure class="wp-block-image alignnone size-medium wp-image-55960">
 <img loading="lazy" decoding="async" width="654" height="510" src="/images/posts/2022/05/diving-into-jvm-framework-monitoring-and-profiling/Image_4-654x510.png" alt="Image 4.: When element is not available response is 400, Bad request" class="wp-image-55960">
 <figcaption>
...
<figure class="wp-block-image alignnone size-medium wp-image-55961">
 <img loading="lazy" decoding="async" width="700" height="377" src="/images/posts/2022/05/diving-into-jvm-framework-monitoring-and-profiling/Image_5-700x377.png" alt="Image 5.: Spring-Boot kotlin grafana heap monitoring " class="wp-image-55961">
 <figcaption>
...
<figure class="wp-block-image alignnone size-medium wp-image-55962">
 <img loading="lazy" decoding="async" width="700" height="407" src="/images/posts/2022/05/diving-into-jvm-framework-monitoring-and-profiling/Image_6-700x407.png" alt="Image 6.: Quarkus on java monitoring, response times are getting higher" class="wp-image-55962">
 <figcaption>
...
![Image 7.: Problematic GC behavior in each pod recorded by Java Flight Recorder.](/images/posts/2022/05/diving-into-jvm-framework-monitoring-and-profiling/Image_11-480x510.png) **Figure 7.** : Problematic GC behaviour in each pod recorded by Java Flight Recorder.
...
<figure class="wp-block-image alignnone size-medium wp-image-55964">
 <img loading="lazy" decoding="async" width="435" height="510" src="/images/posts/2022/05/diving-into-jvm-framework-monitoring-and-profiling/Image_13-435x510.png" alt="Image 8.: Considered frameworks threads initiated by default." class="wp-image-55964">
 <figcaption>
...
<figure class="wp-block-image alignnone size-medium wp-image-55965">
 <img loading="lazy" decoding="async" width="700" height="247" src="/images/posts/2022/05/diving-into-jvm-framework-monitoring-and-profiling/Image_12-700x247.png" alt="Image 9.: Highlighted problematic hot method discovered by analyzing Java Flight recording with focused threads selection" class="wp-image-55965">
 <figcaption>
