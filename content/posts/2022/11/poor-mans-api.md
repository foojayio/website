...
You need to think about the model, the design, the REST principles, etc., without writing a single line of code.
...
![](/images/posts/2022/11/poor-mans-api/table.png)
...
For example, the database user cannot change the data, but everybody can actually access it. It might not be a big issue for product-related data, but what about medical data?
...
Suppose we want to disallow unauthorized people to access our data: Regular users can access products, while admin users can access both the Open API spec **and** products.
...
<img decoding="async" class="size-medium wp-image-61082 aligncenter" src="/images/posts/2022/11/poor-mans-api/grafana-700x288.jpg" alt="" width="700" height="288">
...
To fix it, you need to set a façade in front of PostgREST, a reverse proxy, or even better, an API Gateway.

Apache APISIX offers a wide range of features, from authorization to monitoring. With it, you can quickly validate your API requirements at a low cost.
