...
The [DevRel collective](https://devrelcollective.fun/) is a community where people in the developer relations field can chat and help each other out. But this post isn't about that group... We'll get to that. This is an article about you: the startup founder or manager who's trying to hire your first developer relations person. This article is here to help you by example.

I'm not the first to write about this problem. Taylor Barnett [wrote a great piece on this as well](https://taylorbar.net/posts/recruiting-your-first-developer-advocate:-the-first-email/). Be sure to check it out!
...
How It Started {#h2-0-how-it-started}
-------------------------------------

[Wesley Faulkner](https://twitter.com/wesley83) started this by opening this thread on the DevRel collective community Slack:
...
I (Shai) have been the first developer advocate at [Lightrun](https://lightrun.com/), and I can very much empathize with those sentiments.

What Do You Do? {#h2-1-what-do-you-do}
--------------------------------------
...
What Does a Developer Advocate Do? {#h2-2-what-does-a-developer-advocate-do}
----------------------------------------------------------------------------
...
How Do You Begin? {#h2-3-how-do-you-begin}
------------------------------------------
...
Founder in DevRel? {#h2-4-founder-in-devrel}
--------------------------------------------
...
Some Other Thoughts {#h2-5-some-other-thoughts}
-----------------------------------------------
