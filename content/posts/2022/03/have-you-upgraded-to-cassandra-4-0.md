...
![](/images/posts/2022/03/have-you-upgraded-to-cassandra-4-0/shutterstock_140530141-350x233-1.jpg) © Shutterstock / Phototribe   
...
### **Five times faster scaling operations** {#h3-1-five-times-faster-scaling-operations}
...
### **Incremental repair improvements** {#h3-2-incremental-repair-improvements}
...
![](/images/posts/2022/03/have-you-upgraded-to-cassandra-4-0/incremental-repair-light-2x-768x332-1.png)

### Visibility through virtual tables {#h3-3-visibility-through-virtual-tables}
...
### Greater security and observability {#h3-4-greater-security-and-observability}
...
![](/images/posts/2022/03/have-you-upgraded-to-cassandra-4-0/audit-logging-light-2x-768x1090-1-721x1024.png)

### Java 11 support {#h3-5-java-11-support}
...
![](/images/posts/2022/03/have-you-upgraded-to-cassandra-4-0/throughput-results-light-2x-768x491-1.png)

### Better compression {#h3-6-better-compression}
...
Growth of the Cassandra ecosystem {#h2-7-growth-of-the-cassandra-ecosystem}
---------------------------------------------------------------------------
...
Ready to upgrade? {#h2-8-ready-to-upgrade}
------------------------------------------
...
### 1. Verify your software versions {#h3-9-1-verify-your-software-versions}
...
### 2. Perform a cluster-wide snapshot {#h3-10-2-perform-a-cluster-wide-snapshot}
...
### 3. Upgrade the first node and verify {#h3-11-3-upgrade-the-first-node-and-verify}
...
### 4. Continue to each node in your cluster {#h3-12-4-continue-to-each-node-in-your-cluster}
