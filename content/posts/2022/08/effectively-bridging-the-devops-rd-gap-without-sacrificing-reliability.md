...
Everything's Perfect in our Development Process, Right? {#h2-0-everything-s-perfect-in-our-development-process-right}
---------------------------------------------------------------------------------------------------------------------
...
That Thin (possibly blue) Line {#h2-1-that-thin-possibly-blue-line}
-------------------------------------------------------------------
...
### The Continuous Integration Churn {#h3-2-the-continuous-integration-churn}
...
### Access Limits and Security Teams {#h3-3-access-limits-and-security-teams}
...
Collaboration Between Development and Operations Teams {#h2-4-collaboration-between-development-and-operations-teams}
---------------------------------------------------------------------------------------------------------------------
...
### Observability Tools {#h3-6-observability-tools}
...
Continuous Observability Tools to Save the Day {#h2-7-continuous-observability-tools-to-save-the-day}
-----------------------------------------------------------------------------------------------------
...
### The Line Preserved {#h3-8-the-line-preserved}
...
### In Practical Terms -- How does it Work? {#h3-9-in-practical-terms-how-does-it-work}
...
TL;DR Applying Continuous Observability into your Agile Practices {#h2-10-tl-dr-applying-continuous-observability-into-your-agile-practices}
--------------------------------------------------------------------------------------------------------------------------------------------
