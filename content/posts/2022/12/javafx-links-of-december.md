...
Various News {#h2-1-various-news}
---------------------------------
...
* Shared by [**Johan Vos**](https://mastodon.social/@johanvos):
  * [A major refactory/simplification on how JavaFX deals with windows and window managers on Linux is making progress](https://mastodon.social/@johanvos/109426954082587493). See this [pull request](https://github.com/openjdk/jfx/pull/915). All credits should go to [**Thiago Sayão**](https://twitter.com/thiago_sayao)!
  * "[Maybe it's time to think about moving JavaFX development to a foundation](https://mastodon.social/@johanvos/109444928640623866), and have it developed in a vendor-neutral environment, where contributors are highly respected. That would require commitments from the industries that use JavaFX of course."
...
* [**Sean Gilligan**](https://twitter.com/msgilligan) got triggered by a tweet by **Johan Vos** about webcam support for OpenJDK/JavaFX. He has some ideas and prototype. [Read the thread here](https://twitter.com/msgilligan/status/1600214413684150272).
  * Follow-up messages showing [he is making progress...](https://foojay.social/@msgilligan/109491263323925811).
...
Learning JavaFX {#h2-2-learning-javafx}
---------------------------------------
...
* [**Donald Raab**](https://twitter.com/TheDonRaab) shared a series of posts:
  ...
  * Part 2: [Java Records, DatePicker, and TableView components in JavaFX](https://medium.com/javarevisited/experimenting-with-java-records-datepicker-and-tableview-in-javafx-446ff272dfd2).
...
New content on [jfx-central.com](https://www.jfx-central.com) {#h2-5-new-content-on-jfx-central-com}
----------------------------------------------------------------------------------------------------
...
New Releases {#h2-6-new-releases}
---------------------------------
