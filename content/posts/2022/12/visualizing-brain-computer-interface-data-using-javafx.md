...
<figure class="wp-block-gallery has-nested-images columns-default is-cropped wp-block-gallery-1 is-layout-flex wp-block-gallery-is-layout-flex">
 <figure class="wp-block-image size-large">
  <a href="/images/posts/2022/12/visualizing-brain-computer-interface-data-using-javafx/trinity-skyline.png" target="_blank" rel="noopener"><img fetchpriority="high" decoding="async" width="1024" height="576" data-id="61170" src="/images/posts/2022/12/visualizing-brain-computer-interface-data-using-javafx/trinity-skyline-1024x576.png" alt="" class="wp-image-61170"></a>
  <figcaption>
   Trinity intro and main menu
  </figcaption>
 </figure>
 <figure class="wp-block-image size-large">
  <a href="/images/posts/2022/12/visualizing-brain-computer-interface-data-using-javafx/trinity-hyperspace.png" target="_blank" rel="noopener"><img decoding="async" width="1024" height="576" data-id="61169" src="/images/posts/2022/12/visualizing-brain-computer-interface-data-using-javafx/trinity-hyperspace-1024x576.png" alt="" class="wp-image-61169"></a>
  <figcaption>
   Trinity Hyperspace Tool
  </figcaption>
 </figure>
 <figure class="wp-block-image size-large">
  <a href="/images/posts/2022/12/visualizing-brain-computer-interface-data-using-javafx/trinity-hypersurface.png" target="_blank" rel="noopener"><img decoding="async" width="1024" height="576" data-id="61168" src="/images/posts/2022/12/visualizing-brain-computer-interface-data-using-javafx/trinity-hypersurface-1024x576.png" alt="" class="wp-image-61168"></a>
  <figcaption>
...
Project History {#h2-0-project-history}
---------------------------------------
...
What Data is Used {#h2-1-what-data-is-used}
-------------------------------------------
...
Visualization Tools {#h2-2-visualization-tools}
-----------------------------------------------
...
### Hypersurface Tool {#h3-3-hypersurface-tool}
...
### Hyperspace Tool {#h3-4-hyperspace-tool}
...
Why Java and JavaFX are the Perfect Tools {#h2-5-why-java-and-javafx-are-the-perfect-tools}
-------------------------------------------------------------------------------------------
...
What is used for Trinity? {#h2-6-what-is-used-for-trinity}
----------------------------------------------------------
