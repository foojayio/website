...
Why modularity? {#h2-0-why-modularity}
--------------------------------------
...
Modules, modules everywhere {#h2-1-modules-modules-everywhere}
--------------------------------------------------------------
...
A tentative approach to enforce boundaries {#h2-2-a-tentative-approach-to-enforce-boundaries}
---------------------------------------------------------------------------------------------
...
Spring Modulith {#h2-3-spring-modulith}
---------------------------------------
...
<img fetchpriority="high" decoding="async" class="size-medium wp-image-61030 aligncenter" src="/images/posts/2022/12/spring-modulith-modularity-maturity/architecture-480x510.png" alt="" width="480" height="510">

<br />

Let's check the design of the pricing feature:

<img decoding="async" class="size-medium wp-image-61031 aligncenter" src="/images/posts/2022/12/spring-modulith-modularity-maturity/pricing-original-576x510.png" alt="" width="576" height="510">
...
<img decoding="async" class="size-medium wp-image-61032 aligncenter" src="/images/posts/2022/12/spring-modulith-modularity-maturity/pricing-improved-526x510.png" alt="" width="526" height="510">
...
<img loading="lazy" decoding="async" class="size-medium wp-image-61033 aligncenter" src="/images/posts/2022/12/spring-modulith-modularity-maturity/pricing-final-700x422.png" alt="" width="700" height="422">
