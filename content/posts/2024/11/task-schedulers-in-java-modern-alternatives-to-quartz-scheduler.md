...
![](/images/posts/2024/11/task-schedulers-in-java-modern-alternatives-to-quartz-scheduler/dashboard.jpeg)
...
* db-scheduler
  * [db-scheduler Repository](https://github.com/kagkarlsson/db-scheduler)
* Temporal
  * [Temporal website](https://temporal.io/)
  * [Temporal Repository](https://github.com/temporalio/temporal)
* Kestra
  * [Kestra website](https://kestra.io/)
  * [Kestra Repository](https://github.com/kestra-io/kestra)
