...
Space Invaders {#h2-0-space-invaders}
-------------------------------------
...
Get the tools ready {#h2-1-get-the-tools-ready}
-----------------------------------------------
...
Run the game {#h2-2-run-the-game}
---------------------------------
...
### Attach and suspend {#attach-suspend}
...
Find the relevant objects {#h2-4-find-the-relevant-objects}
-----------------------------------------------------------
...
Labels and expressions {#h2-5-labels-and-expressions}
-----------------------------------------------------
...
Hook the expression {#h2-6-hook-the-expression}
-----------------------------------------------
