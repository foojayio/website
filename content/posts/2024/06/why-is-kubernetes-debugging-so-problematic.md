...
### The Immutable Nature of Containers {#h3-0-the-immutable-nature-of-containers}
...
### The Limitations of `kubectl exec` {#h3-1-the-limitations-of-kubectl-exec}
...
### Avoiding Direct Modifications {#h3-2-avoiding-direct-modifications}
...
### Enter Ephemeral Containers {#h3-3-enter-ephemeral-containers}
...
### Practical Application of Ephemeral Containers {#h3-4-practical-application-of-ephemeral-containers}
...
### Security Considerations {#h3-5-security-considerations}
...
### Interlude: The Role of Observability {#h3-6-interlude-the-role-of-observability}
...
### Command Line Debugging {#h3-7-command-line-debugging}
...
### Connecting a Standard IDE for Remote Debugging {#h3-8-connecting-a-standard-ide-for-remote-debugging}
