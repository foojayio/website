...
[![](/images/posts/2024/06/even-more-opentelemetry/otel-component-model.png)](/images/posts/2024/06/even-more-opentelemetry/otel-component-model.png)I want to be able to add more components. Thus, I decided that instead of directly querying the database, the `inventory` component would query warehouses, which are supposed to be located in different regions. Each warehouse can be implemented in a different stack, and you can have as many as you want---PRs are welcome. I miss Elixir and .Net at the moment. The contract, which I need to write down, is easy:

* An endpoint `/stocks/${productId}`
* The ability to query PostgreSQL
* Return the stock in the form:![](/images/posts/2024/06/even-more-opentelemetry/stock-class-model.png)
...
![](/images/posts/2024/06/even-more-opentelemetry/postrgres-otel-agent-trace.png)

Here's the one from the Gorm framework, instrumented manually.

![](/images/posts/2024/06/even-more-opentelemetry/postgres-gorm-trace.png)
...
![](/images/posts/2024/06/even-more-opentelemetry/redis-lettuce-trace.png)
