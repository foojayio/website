...
![](/images/posts/2024/02/12-lessons-learned-from-doing-the-one-billion-row-challenge/1brc-first-attempt.png) Lesson 1️⃣: Measure performance on production (like) hardware.
...
![](/images/posts/2024/02/12-lessons-learned-from-doing-the-one-billion-row-challenge/1brc-flameview2-1024x421.png) *-XX:StartFlightRecording=duration=15s,settings=profile,name=CalculateAverage_japplis,filename=flight-recorder.jfr,dumponexit=true*   
...
[![](/images/posts/2024/02/12-lessons-learned-from-doing-the-one-billion-row-challenge/1brc-total-1024x246.png)](/images/posts/2024/02/12-lessons-learned-from-doing-the-one-billion-row-challenge/1brc-total.png)
