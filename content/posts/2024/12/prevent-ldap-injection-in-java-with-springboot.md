...
<img fetchpriority="high" decoding="async" aria-describedby="caption-attachment-114911" class="size-medium wp-image-114911" src="/images/posts/2024/12/prevent-ldap-injection-in-java-with-springboot/2ldap-search-700x407.png" alt="Prevent LDAP injection in Java with SpringBoot" width="700" height="407">
...
![Normal input without injection in the Spring Boot form.](/images/posts/2024/12/prevent-ldap-injection-in-java-with-springboot/2normal-input-700x270.png)
...
Prevent LDAP injection in #java 💥💉with #springboot](/images/posts/2024/12/prevent-ldap-injection-in-java-with-springboot/2injection-blocked-700x233.png "Prevent LDAP injection in #java 💥💉with #springboot")

* **Without** these escaping methods, we would have accessed **prohibited data.** 😱

![Injection passing through.
Prevent LDAP injection in #java 💥💉with #springboot](/images/posts/2024/12/prevent-ldap-injection-in-java-with-springboot/2injection-done-700x248.png "Prevent LDAP injection in #java 💥💉with #springboot")
