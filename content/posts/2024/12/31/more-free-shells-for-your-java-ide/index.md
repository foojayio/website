...
authors:
  - "anthony-goubard"
image: "shell-prompt-java2-1.png"
categories:
  - "Desktop"
  - "Eclipse"
  - "IntelliJ IDEA"
...
[![Windows Command Prompt in NetBeans IDE](shell-command-prompt-netbeans.png)](shell-command-prompt-netbeans.png) *Windows Command Prompt in Apache NetBeans IDE*
