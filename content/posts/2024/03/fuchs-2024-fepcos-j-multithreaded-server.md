...
<figure class="aligncenter size-medium">
 <img fetchpriority="high" decoding="async" width="510" height="510" src="/images/posts/2024/03/fuchs-2024-fepcos-j-multithreaded-server/fuchs-2024-multithreaded-tcp-ip-server-510x510.png" alt="An abstract example realization of a multithreaded TCP/IP server." class="wp-image-106204">
...
<figure class="aligncenter size-medium">
 <img decoding="async" width="550" height="510" src="/images/posts/2024/03/fuchs-2024-fepcos-j-multithreaded-server/fuchs-2024-multithreaded-server-with-fepcos-j-example-idServer-550x510.png" alt="A screenshot shows the exemplary realization of a multithreaded server in Java with FEPCOS-J." class="wp-image-106191">
 <figcaption class="wp-element-caption">
