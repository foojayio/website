...
Cons of writing a plugin {#h2-0-cons-of-writing-a-plugin}
---------------------------------------------------------
...
The `vars` and `filter_func` parameters {#h2-1-the-vars-and-filter-func-parameters}
-----------------------------------------------------------------------------------
...
The `serverless` plugin {#h2-2-the-serverless-plugin}
-----------------------------------------------------
...
The `script` parameter {#h2-3-the-script-parameter}
---------------------------------------------------
...
The `_meta.filter` parameter {#h2-4-the-meta-filter-parameter}
--------------------------------------------------------------
