...
[![](/images/posts/2024/09/health-check-response-format-for-http-apis/sample-healthcheck-response-1024x610.png)](/images/posts/2024/09/health-check-response-format-for-http-apis/sample-healthcheck-response.png)
...
![](/images/posts/2024/09/health-check-response-format-for-http-apis/root-object-response.png)
...
![](/images/posts/2024/09/health-check-response-format-for-http-apis/root-object-healthcheck.png)
...
![](/images/posts/2024/09/health-check-response-format-for-http-apis/links-object-healthcheck.png)
...
![](/images/posts/2024/09/health-check-response-format-for-http-apis/checks-object-healthcheck-1024x376.png)

I tried implementing the above with Spring Boot using a custom `HealthIndicator`. Here's the best I could come up with:

[![](/images/posts/2024/09/health-check-response-format-for-http-apis/spring-boot-healthcheck-1024x101.png)](/images/posts/2024/09/health-check-response-format-for-http-apis/spring-boot-healthcheck.png)
