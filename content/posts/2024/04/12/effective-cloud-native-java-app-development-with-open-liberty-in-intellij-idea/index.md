...
authors:
  - "grace-jansen"
image: "ScreenshotLibertyToolsIntelliJ.png"
categories:
  - "Cloud"
  - "Developer Tools"
  - "Gradle"
...
![Screenshot of IntelliJ Run/Debug Configuration menu](Screenshot-2024-04-03-at-13.23.47-700x397.png)
...
![Screenshot of where the Liberty Tools window can be located within IntelliJ IDEA](Screenshot-2024-04-03-at-13.33.06-700x400.png)
