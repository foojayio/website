...
![post banner](/images/posts/2024/04/debug-without-breakpoints/debug-without-breakpoints-banner-1024x538.png)
...
<figure class="wp-block-image size-large is-resized">
 <img decoding="async" width="1024" height="370" src="/images/posts/2024/04/debug-without-breakpoints/pause-button-dark-1024x370.png" alt="Pause button on the debugger's toolbar" class="wp-image-109432" style="width:692px">
</figure>
...
<figure class="wp-block-image size-large is-resized">
 <img decoding="async" width="1024" height="370" src="/images/posts/2024/04/debug-without-breakpoints/paused-program-dark-1024x370.png" alt="Debugger looks the same regardless of whether Pause or a breakpoint was used to suspend the app" class="wp-image-109433" style="width:692px">
</figure>
...
<figure class="wp-block-image size-large is-resized">
 <img loading="lazy" decoding="async" width="1024" height="370" src="/images/posts/2024/04/debug-without-breakpoints/inspect-blocked-thread-dark-1024x370.png" alt="The stack of the blocked UI thread shows what method it is currently executing" class="wp-image-109434" style="width:692px">
</figure>
...
<figure class="wp-block-image size-full is-resized">
 <img loading="lazy" decoding="async" width="680" height="766" src="/images/posts/2024/04/debug-without-breakpoints/hehe.png" alt="hehe cat meme" class="wp-image-109435" style="width:200px">
</figure>
...
<figure class="wp-block-image size-large is-resized">
 <img loading="lazy" decoding="async" width="1024" height="441" src="/images/posts/2024/04/debug-without-breakpoints/debug-locks-with-pause-dark-1024x441.png" alt="The list of threads shows which threads have ended up in a deadlock" class="wp-image-109436" style="width:692px">
</figure>
