...
1️⃣ URL Encoding and Decoding {#h2-0-1-url-encoding-and-decoding}
-----------------------------------------------------------------
...
[![](/images/posts/2024/04/12-text-tools-for-developers/toolbox-url-encode.png)](https://www.japplis.com/toolbox/) *Japplis Toolbox URL Encoding tool in dark mode*

2️⃣ Query Parameters {#h2-1-2-query-parameters}
-----------------------------------------------
...
![](/images/posts/2024/04/12-text-tools-for-developers/toolbox-query-parameters-decoding.png) *Japplis Toolbox Query Parameters decoding tool in always on top mode (Shift F12) and translucent (Ctrl Shift F12 \& Shift Alt Mouse Wheel)*

3️⃣ Match Regular Expression {#h2-2-3-match-regular-expression}
---------------------------------------------------------------
...
[![](/images/posts/2024/04/12-text-tools-for-developers/toolbox-find-regexp.png)](https://plugins.jetbrains.com/plugin/16682-applet-runner/) *Japplis Toolbox Contains regexp tool running inside JetBrains Intellij IDEA using the [Applet Runner plugin](https://plugins.jetbrains.com/plugin/16682-applet-runner/)*

In this example removing the '*\\b*' would find more matches.

4️⃣ Find Regular Expression {#h2-3-4-find-regular-expression}
-------------------------------------------------------------
...
[![](/images/posts/2024/04/12-text-tools-for-developers/toolbox-extract-regexp-netbeans-1024x576.png)](/images/posts/2024/04/12-text-tools-for-developers/toolbox-extract-regexp-netbeans.png) *Japplis Toolbox Keep regexp tool running inside Apache NetBeans using the [NetBeans Applet Runner plugin](https://plugins.netbeans.apache.org/catalogue/?id=57)*
...
5️⃣ Unicode Encoding and Decoding {#h2-4-5-unicode-encoding-and-decoding}
-------------------------------------------------------------------------
...
![](/images/posts/2024/04/12-text-tools-for-developers/toolbox-unicode-encode.png) *Japplis Toolbox converting Japanese text to unicode for a user_ja.properties file*

6️⃣ UTF-8 {#h2-5-6-utf-8}
-------------------------
...
![](/images/posts/2024/04/12-text-tools-for-developers/toolbox-characters-greek.png) *Japplis Toolbox Characters tool with Font, Charset, Block and type choices*

Note that you can copy the character to the clipboard.

7️⃣ 1710942147063 {#h2-6-7-1710942147063}
-----------------------------------------
...
![](/images/posts/2024/04/12-text-tools-for-developers/toolbox-long-to-date.png) *Japplis Toolbox converting epoch time to a more human readable date/time (Zoomed UI 1.5)*

8️⃣ JSON and XML Formatter {#h2-7-8-json-and-xml-formatter}
-----------------------------------------------------------

When testing a web service, you may receive an unformatted answer. Japplis Toolbox includes an XML and JSON formatter.  
![](/images/posts/2024/04/12-text-tools-for-developers/toolbox-format-json.png) *Japplis Toolbox doing JSON formatting*

9️⃣ JSON and XML Explorer {#h2-8-9-json-and-xml-explorer}
---------------------------------------------------------
...
[![](/images/posts/2024/04/12-text-tools-for-developers/tree-data-explorer.png)](https://www.japplis.com/tree-data-explorer/) *Screenshot of Tree Data Explorer exploring a JSON*
...
🔟 Characters Count {#h2-9-characters-count}
--------------------------------------------
...
![](/images/posts/2024/04/12-text-tools-for-developers/toolbox-characters-count.png) *Japplis Toolbox Text Characterics tools*

1️⃣1️⃣ Number Lines {#h2-10-1-1-number-lines}
---------------------------------------------

You may need to explain code or data and to reference the line numbers.  
![](/images/posts/2024/04/12-text-tools-for-developers/toolbox-number-lines.png) *Japplis Toolbox adding line numbers*
...
1️⃣2️⃣ Combine Tools {#h2-11-1-2-combine-tools}
-----------------------------------------------
...
![](/images/posts/2024/04/12-text-tools-for-developers/toolbox-combine-1.png)  
![](/images/posts/2024/04/12-text-tools-for-developers/toolbox-combine-2.png)  
![](/images/posts/2024/04/12-text-tools-for-developers/toolbox-combine-3.png)  
![](/images/posts/2024/04/12-text-tools-for-developers/toolbox-combine-4.png)  
![](/images/posts/2024/04/12-text-tools-for-developers/toolbox-combine-5.png)  
[![](/images/posts/2024/04/12-text-tools-for-developers/poster-font-extensions.png)](https://www.japplis.com/poster-font/) *[Poster Font](https://www.japplis.com/poster-font/) for text to image*

Going Further {#h2-12-going-further}
------------------------------------
