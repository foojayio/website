...
So, to help make this easier (and free!) for Java developers, the Open Liberty team created the first-ever Liberty badge: [Liberty Developer Essentials](https://ibm.biz/FooJayLibertyDeveloperEssentialsBadge "Liberty Developer Essentials")!

This badge enables developers to showcase their ability to use open source technologies, such as [Open Liberty](https://openliberty.io/ "Open Liberty"), [Jakarta EE](https://jakarta.ee/ "Jakarta EE"), and [MicroProfile](https://microprofile.io/ "MicroProfile"), to effectively create a cloud-native Java application.

![Screenshot of Liberty Developer Essentials badge on Credly website](/images/posts/2024/08/get-recognized-for-your-cloud-native-java-development-skills-with-this-new-badge/Screenshot-2024-08-19-at-16.22.35-700x478.png)
...
Who should apply for this badge? {#h2-0-who-should-apply-for-this-badge}
------------------------------------------------------------------------

New Java developers and experienced Java developers can both benefit from this badge!

### New developers {#h3-1-new-developers}
...
### Experienced developers: {#h3-2-experienced-developers}
...
How can I get this badge? {#h2-3-how-can-i-get-this-badge}
----------------------------------------------------------
...
### Hands-on Course {#h3-4-hands-on-course}

Developers who complete the [Essentials for Cloud-Native Java Application Development](https://cognitiveclass.ai/courses/essentials-for-java-application-development-with-liberty "Essentials for Cloud-Native Java Application Development") beginner-level course on [cognitiveclass.ai](https://cognitiveclass.ai/ "cognitiveclass.ai") can earn this badge.
...
![Screenshot of Essentials for Cloud Native Java Application Development course on cognitiveclass.ai site](/images/posts/2024/08/get-recognized-for-your-cloud-native-java-development-skills-with-this-new-badge/LibertyBadge2-700x378.png)
...
The first of many... {#h2-6-the-first-of-many}
----------------------------------------------
...
Get your Liberty Developer Essentials Badge today! {#h2-7-get-your-liberty-developer-essentials-badge-today}
------------------------------------------------------------------------------------------------------------
...
![Screenshot of the icon for the Liberty Developer Essentials badge](/images/posts/2024/08/get-recognized-for-your-cloud-native-java-development-skills-with-this-new-badge/LibertyBadgeIcon-516x510.png)
