...
authors:
  - "geertjan-wielenga"
  - "simonritter"
image: "/images/posts/2024/08/consequences-of-dora-on-java-and-openjdk-with-azul/dora.png"
categories:
  - "EU DORA Act"
  - "Java Core"
  - "Performance"
...
### Key Points of DORA {#h3-0-key-points-of-dora}
...
### Five Important Tasks for Compliance {#h3-1-five-important-tasks-for-compliance}
...
### 1. **Develop and Implement a Comprehensive ICT Risk Management Framework** {#h3-2-1-develop-and-implement-a-comprehensive-ict-risk-management-framework}
...
### 2. **Establish an Incident Reporting Mechanism** {#h3-3-2-establish-an-incident-reporting-mechanism}
...
### 3. **Conduct Regular and Rigorous Testing of ICT Systems** {#h3-4-3-conduct-regular-and-rigorous-testing-of-ict-systems}
...
### 4. **Enhance Third-Party Risk Management Practices** {#h3-5-4-enhance-third-party-risk-management-practices}
...
### 5. **Facilitate Information Sharing on Cyber Threats** {#h3-6-5-facilitate-information-sharing-on-cyber-threats}
...
### Consequences of Using Unsupported OpenJDK Distributions {#h3-7-consequences-of-using-unsupported-openjdk-distributions}
