...
authors:
  - "nicolas-frankel"
image: "micrometer-tracing-otel.png"
categories:
  - "DevOps"
  - "OpenTelemetry"
  - "Spring"
...
![Sample app sequence diagram](app-sequence.png)
...
![Micrometer traces on Jaeger with no customization](trace-micrometer-basic.png)
...
![Sample app sequence diagram](observation-api-classes.png)
...
![Agent v1 traces on Jaeger with no customization](trace-agent-1x-basic.png)
...
![@WithSpan class diagram](withspan-class-diagram.png)
...
![Agent v2 traces on Jaeger with no customization](trace-agent-2x-basic.png)
