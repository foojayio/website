...
<figure class="wp-block-image wp-image-110991 size-medium">
 <img fetchpriority="high" decoding="async" width="700" height="373" src="/images/posts/2024/05/getting-started-with-jobrunr-a-powerful-task-scheduler-in-ja/jobrunr-dashboard-jobs-page-700x373.png" alt="The jobs page on the dashboard of JobRunr
