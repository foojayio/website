...
3. `transferToHost`: it defines the data objects in which we expect the output of our computation. This could be one or many objects. Additionally, we pass a mode.  
...
Cool, isn't it? If you want to know more about dynamic reconfiguration, [this paper](https://jjfumero.github.io/files/VEE2019_Fumero_Preprint.pdf) contains more details.
