...
Choosing Between Fail-Fast and Fail-Safe {#h2-2-choosing-between-fail-fast-and-fail-safe}
-----------------------------------------------------------------------------------------
...
### Balancing Both {#h3-3-balancing-both}
...
### Consistent Layer Behavior {#h3-4-consistent-layer-behavior}
...
### Retry's Are not Fail-Safe {#h3-5-retry-s-are-not-fail-safe}
...
Redefining Failure {#h2-6-redefining-failure}
---------------------------------------------
...
### Data Corruption {#h3-7-data-corruption}
...
### Don't Fix the Bug {#h3-8-don-t-fix-the-bug}
...
Debugging Failure {#h2-9-debugging-failure}
-------------------------------------------
...
### Avoiding Cascading Failure {#h3-10-avoiding-cascading-failure}
...
Hybrid in Production {#h2-11-hybrid-in-production}
--------------------------------------------------
