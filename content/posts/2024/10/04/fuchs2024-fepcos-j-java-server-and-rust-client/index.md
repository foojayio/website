...
authors:
  - "gerhard-fuchs"
image: "fuchs2024-java-server-and-rust-client-example.png"
categories:
  - "Developer Tools"
  - "Use Cases"
tags:
...
![A screenshot of a Linux shell shows the execution of an example server implemented with FEPCOS-J.](fuchs2024-java-server-execution-example.png) **Fig. 5) Executing the example Java server implemented with FEPCOS-J.**
