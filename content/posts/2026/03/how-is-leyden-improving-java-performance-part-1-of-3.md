...
A Brief History of Java Performance {#h2-0-a-brief-history-of-java-performance}
-------------------------------------------------------------------------------
...
### Why Java takes time to reach peak performance {#h3-1-why-java-takes-time-to-reach-peak-performance}
...
![Image representing the normal flow of a java run, from cold to peak performance as described below](/images/posts/2026/03/how-is-leyden-improving-java-performance-part-1-of-3/regular-java-run-700x238.webp)
...
Housekeeping considered harmful {#h2-2-housekeeping-considered-harmful}
-----------------------------------------------------------------------
...
Leyden Project 'premain' Experiment {#h2-3-leyden-project-premain-experiment}
-----------------------------------------------------------------------------
...
### Training and Production Runs {#h3-4-training-and-production-runs}
...
![Left side there is a JAR blue block with an arrow (training run) pointing to an orange block called AOT cache. Both blocks have arrows to an orange production run.](/images/posts/2026/03/how-is-leyden-improving-java-performance-part-1-of-3/aot-cache-700x328.webp)
