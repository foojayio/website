...
description: "Welcome to another episode of the Foojay Podcast! In this episode, we're talking about Java 26, released on March 17 in the year 26. Again, right on…"
authors:
  - "frankdelporte"
  - "loic-mathieu"
  - "simonritter"
image: "episode-92-java-26.jpg"
categories:
  - "Java"
  - "Java Core"
  - "Podcast"
...
12:02 [JEP 500](https://openjdk.org/jeps/500): Prepare to Make Final Mean Final

13:24 [JEP 526](https://openjdk.org/jeps/526): Lazy Constants (Second Preview)

16:12 [JEP 517](https://openjdk.org/jeps/517): HTTP/3 for the HTTP Client API

* <https://en.wikipedia.org/wiki/HTTP/3>
* <https://en.wikipedia.org/wiki/QUIC>

18:48 [JEP 504](https://openjdk.org/jeps/504): Remove the Applet API

20:52 [JEP 524](https://openjdk.org/jeps/524): PEM Encodings of Cryptographic Objects (Second Preview)

21:59 [JEP 516](https://openjdk.org/jeps/516): Ahead-of-Time Object Caching with Any GC

* <https://openjdk.org/projects/leyden/>
* <https://docs.azul.com/prime/analyzing-tuning-warmup>
* <https://foojay.io/today/faster-java-warmup-crac-versus-readynow/>

25:30 [JEP 522](https://openjdk.org/jeps/522): G1 GC: Improve Throughput by Reducing Synchronization

* [Trash Talk - Exploring the JVM memory management by Gerrit Grunwald](https://www.youtube.com/watch?v=Jh79ojcror0)

28:04 [JEP 525](https://openjdk.org/jeps/525): Structured Concurrency (Sixth Preview)

* <https://openjdk.org/projects/loom/>

31:09 [JEP 529](https://openjdk.org/jeps/529): Vector API (Eleventh Incubator)
...
38:03 [JEP 530](https://openjdk.org/jeps/530): Primitive Types in Patterns, instanceof, and switch (Fourth Preview)

* <https://openjdk.org/projects/amber/>
* [Java Puzzlers talk by Simon](https://www.youtube.com/watch?v=vZ7P2CigLLQ)

42:14 Do we need "Carrier Classes"?

* [Amber mailing list: Data Oriented Programming, Beyond Records](https://mail.openjdk.org/pipermail/amber-spec-experts/2026-January/004307.html)
* [JVM Weekly newsletter by Artur Skowroński](https://www.linkedin.com/pulse/java-reaches-gpu-records-fall-off-cliff-gatherers-prove-skowro%C5%84ski-rnqlf/)

44:38 What changes does Java need for the AI world?

* [JEP DRAFT 8361105](https://openjdk.org/jeps/8361105): Code reflection (Incubator)
