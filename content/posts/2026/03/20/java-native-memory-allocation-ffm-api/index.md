...
What is the Memory API {#h2-0-what-is-the-memory-api}
-----------------------------------------------------
...
### Using Arenas {#h3-2-using-arenas}
...
### Creating your own arena {#h3-3-creating-your-own-arena}
...
Native Memory allocation methods {#h2-4-native-memory-allocation-methods}
-------------------------------------------------------------------------
...
### Using Malloc and Free {#h3-5-using-malloc-and-free}
...
Pool of reusable memory {#h2-6-pool-of-reusable-memory}
-------------------------------------------------------
...
### Why you would use them {#h3-7-why-you-would-use-them}
...
### How to use a memory pool {#h3-8-how-to-use-a-memory-pool}
...
### How to use them {#h3-10-how-to-use-them}
