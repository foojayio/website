...
authors:
  - "shai-almog"
image: "liquid-glass-material-3-modern-native-themes-2.jpg"
categories:
  - "Java"
tags:
related_posts:
...
Try it right now in the Playground {#h2-0-try-it-right-now-in-the-playground}
-----------------------------------------------------------------------------
...
The new native themes {#h2-1-the-new-native-themes}
---------------------------------------------------
...
### Android Material 3 {#h3-3-android-material-3}
...
### Translucent surfaces {#h3-4-translucent-surfaces}
...
### Runtime palette overrides {#h3-5-runtime-palette-overrides}
...
In the simulator {#h2-6-in-the-simulator}
-----------------------------------------
...
Sticky headers {#h2-8-sticky-headers}
-------------------------------------
...
How we test this {#h2-9-how-we-test-this}
-----------------------------------------
...
Bugs and misc features from this week {#h2-10-bugs-and-misc-features-from-this-week}
------------------------------------------------------------------------------------
...
Where this is going --- and a thank-you {#h2-11-where-this-is-going-and-a-thank-you}
------------------------------------------------------------------------------------
...
You can try the new themes today by opening the [Playground](https://www.codenameone.com/playground), by setting `nativeTheme=modern` (or `ios.themeMode=modern` / `and.themeMode=modern` for finer control) in your project's `codenameone_settings.properties`, or by picking them from the simulator's new Native Theme menu. New projects from the initializr already have them on. The shipping resources are bundled in the iOS and Android ports as of this week.
