...
*Codename One is an open-source framework for building native iOS, Android, desktop, and web apps from a single Java or Kotlin codebase. Learn more at [codenameone.com](https://www.codenameone.com/).*

Java 17 by default {#h2-0-java-17-by-default}
---------------------------------------------
...
Native theme accents {#h2-2-native-theme-accents}
-------------------------------------------------

[PR #4884](https://github.com/codenameone/CodenameOne/pull/4884) closes the loop on the new iOS Modern and Material 3 native themes [we shipped two weeks ago](https://www.codenameone.com/blog/liquid-glass-material-3-modern-native-themes/). The native themes now expose their accent palette as named theme constants, so rebranding your app to your own colours is a five-line CSS change instead of a fork.
...
Metal follow-ups {#h2-3-metal-follow-ups}
-----------------------------------------
...
### Per-axis scale decomposition (#4939, fixes #3302) {#h3-4-per-axis-scale-decomposition-4939-fixes-3302}
...
### Clip-under-rotation diagnostic (#4924, towards #3921) {#h3-5-clip-under-rotation-diagnostic-4924-towards-3921}
...
### iOS Metal colour space hint (#4909, fixes #4908) {#h3-6-ios-metal-colour-space-hint-4909-fixes-4908}
...
### The new `translateMatrix` API {#h3-7-the-new-translatematrix-api}
...
String API: `replace(CharSequence, CharSequence)`, `replaceAll`, `replaceFirst` {#h2-8-string-api-replace-charsequence-charsequence-replaceall-replacefirst}
------------------------------------------------------------------------------------------------------------------------------------------------------------
...
iOS push permission no longer fires at app launch {#h2-9-ios-push-permission-no-longer-fires-at-app-launch}
-----------------------------------------------------------------------------------------------------------
...
Skin Designer FAQ follow-up {#h2-10-skin-designer-faq-follow-up}
----------------------------------------------------------------
...
Two reminders. First, **flip `ios.metal=true` on your real app this week** if you have not. The default flip is days away and we would rather find any remaining edge case against your screens than against the install base on launch day. Second, if you have not generated a project from the [Initializr](https://www.codenameone.com/initializr/) recently, do it; the Java 17 default and the `AGENTS.md` skill are both worth seeing for yourself.
...
Issue tracker is [here](https://github.com/codenameone/CodenameOne/issues), the [Playground](https://www.codenameone.com/playground) and [Initializr](https://www.codenameone.com/initializr/) are the easiest places to poke at the new defaults, and the [Skin Designer](https://www.codenameone.com/skindesigner/) from last week is still there if you have a device shape you need a skin for.
