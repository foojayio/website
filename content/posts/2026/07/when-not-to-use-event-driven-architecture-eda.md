...
<img fetchpriority="high" decoding="async" aria-describedby="caption-attachment-124878" class="size-medium wp-image-124878" src="/images/posts/2026/07/when-not-to-use-event-driven-architecture-eda/2noeda-700x467.png" alt="Don't use EDA for everything" width="700" height="467">
