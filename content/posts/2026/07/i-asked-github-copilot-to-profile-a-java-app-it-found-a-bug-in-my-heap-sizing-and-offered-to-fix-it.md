...
slug: "i-asked-github-copilot-to-profile-a-java-app-it-found-a-bug-in-my-heap-sizing-and-offered-to-fix-it"
...
The idea: Copilot-driven profiling {#h2-0-the-idea-copilot-driven-profiling}
----------------------------------------------------------------------------
...
Step 1 --- Copilot ran it, and showed me exactly what it ran {#h2-1-step-1-copilot-ran-it-and-showed-me-exactly-what-it-ran}
----------------------------------------------------------------------------------------------------------------------------
...
### Step 2 --- The verdict in plain language {#h3-2-step-2-the-verdict-in-plain-language}
...
### Step 3 --- One click hands the data back to Copilot {#h3-3-step-3-one-click-hands-the-data-back-to-copilot}
...
### Step 4 --- A root cause, not a summary {#h3-4-step-4-a-root-cause-not-a-summary}
...
### Step 5 --- Recommendations with reasoning {#h3-5-step-5-recommendations-with-reasoning}
...
### Step 6 --- It offered to run the experiment {#h3-6-step-6-it-offered-to-run-the-experiment}
...
### Step 7 --- Prove it worked {#h3-7-step-7-prove-it-worked}
...
### Why this matters {#h3-8-why-this-matters}
