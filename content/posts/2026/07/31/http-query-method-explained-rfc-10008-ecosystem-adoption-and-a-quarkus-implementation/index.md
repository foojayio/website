...
The QUERY Method {#h2-0-the-query-method}
-----------------------------------------
...
### Safe and idempotent {#h3-1-safe-and-idempotent}
...
### Meaning comes from Content-Type {#h3-2-meaning-comes-from-content-type}
...
### Explicitly cacheable {#h3-3-explicitly-cacheable}
...
### Discovery via Accept-Query {#h3-4-discovery-via-accept-query}
...
### The equivalent resource {#h3-5-the-equivalent-resource}
...
### Familiar error semantics {#h3-6-familiar-error-semantics}
...
A decade in the making {#h2-7-a-decade-in-the-making}
-----------------------------------------------------
...
Where ecosystem support stands today {#h2-8-where-ecosystem-support-stands-today}
---------------------------------------------------------------------------------
...
### Apache Tomcat {#h3-9-apache-tomcat}
...
### Eclipse Jetty {#h3-10-eclipse-jetty}
...
### Jakarta Servlet {#h3-11-jakarta-servlet}
...
What about Spring? {#h2-12-what-about-spring}
---------------------------------------------
...
Why Quarkus can do it today {#h2-13-why-quarkus-can-do-it-today}
----------------------------------------------------------------
...
The example: a product catalog you can QUERY {#h2-14-the-example-a-product-catalog-you-can-query}
-------------------------------------------------------------------------------------------------
...
### One query, two media types {#h3-15-one-query-two-media-types}
...
### The response tells the whole story {#h3-16-the-response-tells-the-whole-story}
...
### Discovery without prior knowledge {#h3-17-discovery-without-prior-knowledge}
...
### Proving idempotency {#h3-18-proving-idempotency}
