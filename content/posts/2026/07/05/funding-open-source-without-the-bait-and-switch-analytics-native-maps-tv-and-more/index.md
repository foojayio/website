...
authors:
  - "shai-almog"
image: "funding-open-source-without-the-bait-and-switch.jpg"
categories:
  - "Java"
tags:
related_posts:
...
The deal we actually offer {#h2-0-the-deal-we-actually-offer}
-------------------------------------------------------------
...
The company still has to make enough money to keep paying the people who move the project forward at the pace you have seen this year. That need pulls against the open one, and the usual way companies resolve the tension is to make the open part worse so the paid part looks better. We said it plainly in [We Will Not Sabotage Your Code](https://www.codenameone.com/blog/we-will-not-sabotage-your-code/) a couple of weeks ago: we will not do that, and the model below is how we avoid it.
...
A privacy-first analytics API {#h2-1-a-privacy-first-analytics-api}
-------------------------------------------------------------------
...
Five providers ship in the box: our first-party `CodenameOneAnalyticsProvider` (batched to the cloud, included with every paid subscription down to the basic tier, where the plan sets your data-retention window), `GoogleAnalyticsProvider` for GA4, the privacy-first non-Google `MatomoAnalyticsProvider`, `FirebaseAnalyticsProvider`, and a `LoggingAnalyticsProvider` for development. The old `AnalyticsService` is still there, deprecated, and now delegates to the new API so existing apps keep working. The full walkthrough is in .

Maps you control, down to the pixel {#h2-2-maps-you-control-down-to-the-pixel}
------------------------------------------------------------------------------
...
Apple TV, Android TV, and CSS that knows the form factor {#h2-3-apple-tv-android-tv-and-css-that-knows-the-form-factor}
-----------------------------------------------------------------------------------------------------------------------
...
Device integrity and app review {#h2-5-device-integrity-and-app-review}
-----------------------------------------------------------------------
...
The state of the JavaScript port {#h2-6-the-state-of-the-javascript-port}
-------------------------------------------------------------------------
...
From the community {#h2-7-from-the-community}
---------------------------------------------
...
Upcoming attractions {#h2-8-upcoming-attractions}
-------------------------------------------------

We have a week full of feature deep-dives:

* **Saturday.** . PR [#5264](https://github.com/codenameone/CodenameOne/pull/5264).
* **Sunday.** . PR [#5272](https://github.com/codenameone/CodenameOne/pull/5272).
* **Monday.** . PR [#5266](https://github.com/codenameone/CodenameOne/pull/5266).
* **Tuesday.** . PR [#5261](https://github.com/codenameone/CodenameOne/pull/5261).
* **Wednesday.** . PRs [#5277](https://github.com/codenameone/CodenameOne/pull/5277) and [#5268](https://github.com/codenameone/CodenameOne/pull/5268).
* **Thursday.** . PR [#5253](https://github.com/codenameone/CodenameOne/pull/5253).
