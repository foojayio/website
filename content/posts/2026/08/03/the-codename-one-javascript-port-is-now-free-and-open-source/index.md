...
date: "2026-08-03T15:46:30+00:00"
description: "Codename One's JavaScript port is now open source, available on every plan, and buildable locally without an account. ParparVM is the default, while TeaVM"
canonical: "https://www.codenameone.com/blog/javascript-free-open-source/"
authors:
  - "shai-almog"
...
Why we built the ParparVM JavaScript port {#h2-1-why-we-built-the-parparvm-javascript-port}
-------------------------------------------------------------------------------------------
...
Build the web target without our cloud {#h2-2-build-the-web-target-without-our-cloud}
-------------------------------------------------------------------------------------
...
The proxy is part of deployment now {#h2-3-the-proxy-is-part-of-deployment-now}
-------------------------------------------------------------------------------
...
Why we are making JavaScript available to everyone {#h2-4-why-we-are-making-javascript-available-to-everyone}
-------------------------------------------------------------------------------------------------------------
...
Android API 36 becomes the default next week {#h2-5-android-api-36-becomes-the-default-next-week}
-------------------------------------------------------------------------------------------------
...
Issue #5425: Dave was right about our collector {#h2-6-issue-5425-dave-was-right-about-our-collector}
-----------------------------------------------------------------------------------------------------
...
Calendar API: local calendars, cloud sync, and conflicts {#h2-7-calendar-api-local-calendars-cloud-sync-and-conflicts}
----------------------------------------------------------------------------------------------------------------------
...
The simulator uses an isolated in-memory calendar, so tests never touch the developer's real schedule. [PR #5413](https://github.com/codenameone/CodenameOne/pull/5413) contains the implementation. [Read the calendar API article for recurrence, OAuth boundaries, conflict resolution, and provider synchronization.](https://www.codenameone.com/blog/calendar-is-not-add-event/)

Bluetooth is now part of the core {#h2-8-bluetooth-is-now-part-of-the-core}
---------------------------------------------------------------------------
...
[PR #5399](https://github.com/codenameone/CodenameOne/pull/5399) is a ground-up replacement for the Cordova-derived cn1lib. [Read the Bluetooth article for the role model, platform matrix, GATT queue, simulator, and builder behavior.](https://www.codenameone.com/blog/bluetooth-beyond-ble/)

Pure Codename One text editing {#h2-9-pure-codename-one-text-editing}
---------------------------------------------------------------------
...
[PR #5386](https://github.com/codenameone/CodenameOne/pull/5386) adds the port bindings and portable editor engine. [Read the text-input article for composition, UTF-16 offsets, bidirectional hit testing, rich clipboard negotiation, and the native-overlay tradeoff.](https://www.codenameone.com/blog/text-input-without-native-overlay/)

Lightweight rich text without a web view {#h2-10-lightweight-rich-text-without-a-web-view}
------------------------------------------------------------------------------------------
...
[PR #5421](https://github.com/codenameone/CodenameOne/pull/5421) contains the viewer and shared painter. [Read the rich-text article for supported formats, link and image policies, clipboard negotiation, and when to keep BrowserComponent.](https://www.codenameone.com/blog/rich-text-without-webview/)

Compact strings in ParparVM {#h2-11-compact-strings-in-parparvm}
----------------------------------------------------------------
...
[Read the compact-strings article for the object layout, fused-allocation changes, native-operation audit, and Unicode behavior.](https://www.codenameone.com/blog/compact-strings-parparvm/)

Account, website, and video updates {#h2-12-account-website-and-video-updates}
------------------------------------------------------------------------------

### Authorization migration {#h3-13-authorization-migration}
...
### New website design {#h3-14-new-website-design}
...
### Videos generated from these posts {#h3-15-videos-generated-from-these-posts}
