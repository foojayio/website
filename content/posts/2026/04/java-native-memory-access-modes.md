...
What is Memory Order and Why Does It Matter for Native Memory? {#h2-0-what-is-memory-order-and-why-does-it-matter-for-native-memory}
------------------------------------------------------------------------------------------------------------------------------------
...
### Why do you need all of this? {#h3-1-why-do-you-need-all-of-this}
...
Testing it using JCStress {#h2-2-testing-it-using-jcstress}
-----------------------------------------------------------
...
<pre class="EnlighterJSRAW" data-enlighter-language="text">  RESULT      SAMPLES     FREQ       EXPECT  DESCRIPTION
...
Plain Access (Get/Set) {#h2-3-plain-access-get-set}
---------------------------------------------------
...
Opaque Access {#h2-4-opaque-access}
-----------------------------------
...
<pre class="EnlighterJSRAW" data-enlighter-language="text">  --- OPAQUE ACCESS ---
...
<pre class="EnlighterJSRAW" data-enlighter-language="text">  --- OPAQUE ACCESS  C2 ---
  RESULT     SAMPLES     FREQ       EXPECT  DESCRIPTION
...
Acquire/Release {#h2-5-acquire-release}
---------------------------------------
...
<pre class="EnlighterJSRAW" data-enlighter-language="text">  RESULT      SAMPLES     FREQ
      -1  167,565,777   62.57%
       3  100,243,162   37.43%
</pre>
...
Bonus: Word Tearing {#h2-9-bonus-word-tearing}
----------------------------------------------
...
<pre class="EnlighterJSRAW" data-enlighter-language="text">                                    RESULT      SAMPLES     FREQ       EXPECT
