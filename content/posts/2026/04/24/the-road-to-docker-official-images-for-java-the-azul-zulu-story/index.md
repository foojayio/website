...
What Are Docker Official Images, and Why Does It Matter? {#h-what-are-docker-official-images-and-why-does-it-matter}
--------------------------------------------------------------------------------------------------------------------
...
The Journey: Two Years in the Making {#h-the-journey-two-years-in-the-making}
-----------------------------------------------------------------------------
...
How Azul Zulu Official Images Are Built and Published {#h-how-azul-zulu-official-images-are-built-and-published}
----------------------------------------------------------------------------------------------------------------
...
### Pre-release validation {#h-pre-release-validation}
...
### PM approval and promotion {#h-pm-approval-and-promotion}
...
### Submitting to Docker Hub {#h-submitting-to-docker-hub}
...
What's Changing: From Docker Hub to Docker Official Images {#h-what-s-changing-from-docker-hub-to-docker-official-images}
-------------------------------------------------------------------------------------------------------------------------
...
More Options for Azul Customers {#h-more-options-for-azul-customers}
--------------------------------------------------------------------
