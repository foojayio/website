...
slug: "aws-nitro-and-cpu-graviton-meets-unikernels"
...
AWS Nitro and CPU Graviton Meets Unikernels: Java and Quarkus on ARM64 AWS Graviton with Nanos Unikernel {#h2-0-aws-nitro-and-cpu-graviton-meets-unikernels-java-and-quarkus-on-arm64-aws-graviton-with-nanos-unikernel}
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

![image](https://github.com/user-attachments/assets/2c957ea8-2c6b-4caa-86f8-5adeb9e8bedc)

Java and Jakarta EE Truly Meet Unikernels {#h2-1-java-and-jakarta-ee-truly-meet-unikernels}
-------------------------------------------------------------------------------------------
...
### Reproducibility and Artifacts {#h3-4-reproducibility-and-artifacts}
...
### Local Build and Image Creation {#h3-5-local-build-and-image-creation}
...
### Instance Creation on AWS {#h3-6-instance-creation-on-aws}
...
### PoC Environment {#h3-7-poc-environment}
...
### Container Stack {#h3-10-container-stack}
...
### Unikernel Stack {#h3-11-unikernel-stack}
