...
authors:
  - "geertjan-wielenga"
image: "/images/posts/2026/04/from-zero-to-full-observability-with-dash0/og-image.png"
categories:
  - "Cloud"
  - "Java"
  - "Kubernetes"
...
![](/images/posts/2026/04/from-zero-to-full-observability-with-dash0/kubernetes-dash0-1024x581.png)
...
![](/images/posts/2026/04/from-zero-to-full-observability-with-dash0/dash0-services-1024x298.png)

**Telemetry → Tracing** --- individual traces for each `/orders` request
![](/images/posts/2026/04/from-zero-to-full-observability-with-dash0/dash0-tracing-1024x465.png)

**Telemetry → Logging** --- structured logs
![](/images/posts/2026/04/from-zero-to-full-observability-with-dash0/dash0-pod-logs-1024x545.png)
