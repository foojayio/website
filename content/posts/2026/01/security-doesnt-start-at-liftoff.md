...
slug: "security-doesnt-start-at-liftoff"
...
Are you sitting comfortably? {#h2-0-are-you-sitting-comfortably}
----------------------------------------------------------------
...
The CVE is (almost) not important {#h2-1-the-cve-is-almost-not-important}
-------------------------------------------------------------------------
...
The Inversion of the Security Timeline {#h2-2-the-inversion-of-the-security-timeline}
-------------------------------------------------------------------------------------
...
Habit vs. Hype {#h2-3-habit-vs-hype}
------------------------------------
...
The Flawed Assumption of Loud Alerts {#h2-4-the-flawed-assumption-of-loud-alerts}
---------------------------------------------------------------------------------
...
Prioritising Changes Over Stories {#h2-5-prioritising-changes-over-stories}
---------------------------------------------------------------------------
...
The main timeline {#h2-6-the-main-timeline}
-------------------------------------------
...
How the message dilutes {#h2-8-how-the-message-dilutes}
-------------------------------------------------------
...
A common scenerio {#h2-9-a-common-scenerio}
-------------------------------------------
...
What This Means to You and What to Do Next {#h2-10-what-this-means-to-you-and-what-to-do-next}
----------------------------------------------------------------------------------------------
...
What this means in practice {#h2-11-what-this-means-in-practice}
----------------------------------------------------------------
...
What you should do next {#h2-12-what-you-should-do-next}
--------------------------------------------------------
...
Security does not start at liftoff. {#h2-13-security-does-not-start-at-liftoff}
-------------------------------------------------------------------------------
