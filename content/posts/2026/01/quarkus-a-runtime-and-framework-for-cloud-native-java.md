...
![A brief timeline leading to modern Java and Quarkus](/images/posts/2026/01/quarkus-a-runtime-and-framework-for-cloud-native-java/1-history.png)
...
* **Buildtime optimization** : Quarkus shifts work from runtime to build time wherever possible.  
  This approach reduces startup overhead and memory usage, resulting in a lean, fast, and efficient application tailored for production.![Buildtime principle in Quarkus: being fast by doing less at runtime](/images/posts/2026/01/quarkus-a-runtime-and-framework-for-cloud-native-java/2-build-time-principle.png)
  ...
  ![Benefits of Quarkus buildtime processing on the JVM](/images/posts/2026/01/quarkus-a-runtime-and-framework-for-cloud-native-java/3-BuildTimeP-Benefits-JVM.png)

  Figure 2. Thanks to buildtime initialization, the resulting application starts faster and consumes less memory.

  ![Benefits of Quarkus native image compared to JVM](/images/posts/2026/01/quarkus-a-runtime-and-framework-for-cloud-native-java/4-BuildTimeP-Benefits-native.png)
...
![Frictionless developer experience: live reload, dev services, continuous testing](/images/posts/2026/01/quarkus-a-runtime-and-framework-for-cloud-native-java/6-Frictionless.png)
...
![Real-world success stories using Quarkus](/images/posts/2026/01/quarkus-a-runtime-and-framework-for-cloud-native-java/7-success-stories.png)
...
![Setting expectations for performance and developer experience with Quarkus](/images/posts/2026/01/quarkus-a-runtime-and-framework-for-cloud-native-java/8-expectations.png)
