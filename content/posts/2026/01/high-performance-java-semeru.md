...
Performance for typical Java applications {#h2-0-performance-for-typical-java-applications}
-------------------------------------------------------------------------------------------
...
![](/images/posts/2026/01/high-performance-java-semeru/image01-700x357.jpg)
...
Improving an application's startup and rampup time {#h2-1-improving-an-application-s-startup-and-rampup-time}
-------------------------------------------------------------------------------------------------------------
...
### Improving startup and rampup time with shared classes cache {#h3-2-improving-startup-and-rampup-time-with-shared-classes-cache}
...
![](/images/posts/2026/01/high-performance-java-semeru/image02.png)
...
![](/images/posts/2026/01/high-performance-java-semeru/image03.png)
...
### Improving startup and rampup time with InstantOn {#h3-3-improving-startup-and-rampup-time-with-instanton}
...
![](/images/posts/2026/01/high-performance-java-semeru/image04-700x395.png)
...
![](/images/posts/2026/01/high-performance-java-semeru/image05-700x277.png)
...
![](/images/posts/2026/01/high-performance-java-semeru/image06.png)
...
![](/images/posts/2026/01/high-performance-java-semeru/image07-700x361.png)
...
### Improving startup and rampup time with Semeru Cloud Compiler {#h3-4-improving-startup-and-rampup-time-with-semeru-cloud-compiler}
...
![](/images/posts/2026/01/high-performance-java-semeru/image08-700x288.jpg)
...
![](/images/posts/2026/01/high-performance-java-semeru/image09-2-700x359.jpg)

The following figure illustrates the throughput of the RestCRUD application running on Quarkus with Cloud Compiler.

![](/images/posts/2026/01/high-performance-java-semeru/image10-2-700x425.jpg)
...
![](/images/posts/2026/01/high-performance-java-semeru/image11-700x359.png)
...
Improving an application's throughput {#h2-5-improving-an-application-s-throughput}
-----------------------------------------------------------------------------------
...
### Improving throughput with Semeru Runtimes {#h3-6-improving-throughput-with-semeru-runtimes}
...
![](/images/posts/2026/01/high-performance-java-semeru/image12-700x337.png)
...
![](/images/posts/2026/01/high-performance-java-semeru/image13-700x403.png)
...
Improving an application's memory footprint {#h2-7-improving-an-application-s-memory-footprint}
-----------------------------------------------------------------------------------------------
...
![](/images/posts/2026/01/high-performance-java-semeru/image14-700x363.png)

### Improving memory footprint with Semeru Cloud Compiler {#h3-8-improving-memory-footprint-with-semeru-cloud-compiler}
...
![](/images/posts/2026/01/high-performance-java-semeru/image15-2-700x364.jpg)
...
![](/images/posts/2026/01/high-performance-java-semeru/image16-2-700x424.jpg)

The following figure shows our hypothetical Java application's memory footprint with Cloud Compiler.

![](/images/posts/2026/01/high-performance-java-semeru/image17-700x360.png)
...
### Improving memory footprint with Semeru Runtimes {#h3-9-improving-memory-footprint-with-semeru-runtimes}
...
![](/images/posts/2026/01/high-performance-java-semeru/image18-700x360.png)
...
![](/images/posts/2026/01/high-performance-java-semeru/image19-700x334.png)
