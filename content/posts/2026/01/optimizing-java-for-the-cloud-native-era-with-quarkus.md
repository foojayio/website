...
authors:
  - "michal-maler"
image: "/images/posts/2026/01/optimizing-java-for-the-cloud-native-era-with-quarkus/optimizing-java-with-quarkus-cloud-scaled.png"
categories:
  - "Cloud"
  - "Kubernetes"
  - "Maven"
...
The platform supports commonly used Jakarta specifications like JAX-RS, CDI, JPA, and Bean Validation out of the box. For Spring users, the compatibility layer includes support for widely used annotations and components. See the [Spring DI guide](https://quarkus.io/guides/spring-di) to learn more.
