...
[Kestra](https://kestra.io) is an open-source declarative orchestration platform designed to run, coordinate, and monitor large-scale, event-driven workflows. It is built to handle parallelism, asynchronous execution, and distributed systems at scale, exactly the kind of environment where determinism is hard and flaky tests tend to emerge.
...
Want to try Kestra? You can get started in 5 minutes following the [quickstart guide](https://kestra.io/docs/quickstart).
