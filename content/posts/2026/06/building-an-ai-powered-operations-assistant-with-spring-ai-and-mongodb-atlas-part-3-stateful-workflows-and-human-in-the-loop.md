...
slug: "building-an-ai-powered-operations-assistant-with-spring-ai-and-mongodb-atlas-part-3-stateful-workflows-and-human-in-the-loop"
...
The Remaining Gap {#h2-0-the-remaining-gap}
-------------------------------------------
...
The Core Idea: Externalizing Workflow State {#h2-2-the-core-idea-externalizing-workflow-state}
----------------------------------------------------------------------------------------------
...
The Checkpoint Document {#h2-3-the-checkpoint-document}
-------------------------------------------------------
...
Checkpoint Lifecycle {#h2-4-checkpoint-lifecycle}
-------------------------------------------------
...
![](/images/posts/2026/06/building-an-ai-powered-operations-assistant-with-spring-ai-and-mongodb-atlas-part-3-stateful-workflows-and-human-in-the-loop/fri1-1024x475.png)
...
Giving the Model the Ability to Observe The Systems {#h2-5-giving-the-model-the-ability-to-observe-the-systems}
---------------------------------------------------------------------------------------------------------------
...
Propagating Context Into Tool Methods {#h2-6-propagating-context-into-tool-methods}
-----------------------------------------------------------------------------------
...
Audit Trails with ToolExecution {#h2-7-audit-trails-with-toolexecution}
-----------------------------------------------------------------------
...
Pause, Inspect, Resume {#h2-8-pause-inspect-resume}
---------------------------------------------------
...
A Demo Scenario {#h2-9-a-demo-scenario}
---------------------------------------
...
What This Architecture Makes Possible {#h2-10-what-this-architecture-makes-possible}
------------------------------------------------------------------------------------
