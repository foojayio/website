...
A new Build Cloud UI --- preview {#h2-0-a-new-build-cloud-ui-preview}
---------------------------------------------------------------------
...
Device APIs become first-class {#h2-1-device-apis-become-first-class}
---------------------------------------------------------------------
...
### Biometrics --- [PR #4987](https://github.com/codenameone/CodenameOne/pull/4987) {#h3-2-biometrics-pr-4987}
...
### Cryptography --- [PR #4994](https://github.com/codenameone/CodenameOne/pull/4994) {#h3-3-cryptography-pr-4994}
...
### NFC --- [PR #4996](https://github.com/codenameone/CodenameOne/pull/4996) {#h3-4-nfc-pr-4996}

`com.codename1.nfc` is the third addition. A single `Nfc` entry point, an `NdefMessage` / `NdefRecord` pair with typed factories (`createUri`, `createTex`t, `createMime`, `createExternal`, `createApplicationRecord`), per-technology `Tag` subclasses (`IsoDep`, `MifareClassic`, `MifareUltralight`, `NfcA`, `NfcB`, `NfcF`, `NfcV`), and a `HostCardEmulationService` base class for emulating a contactless card.
...
cn1libs can now own simulator menus --- and that changes Bluetooth {#h2-5-cn1libs-can-now-own-simulator-menus-and-that-changes-bluetooth}
-----------------------------------------------------------------------------------------------------------------------------------------
...
### Bluetooth that you can actually debug {#h3-6-bluetooth-that-you-can-actually-debug}
...
In-app purchase consistency --- [PR #4990](https://github.com/codenameone/CodenameOne/pull/4990) {#h2-7-in-app-purchase-consistency-pr-4990}
--------------------------------------------------------------------------------------------------------------------------------------------
...
UTF-8: JDK-compatible replace semantics + a NEON ASCII fast path --- [PR #4989](https://github.com/codenameone/CodenameOne/pull/4989) {#h2-8-utf-8-jdk-compatible-replace-semantics-a-neon-ascii-fast-path-pr-4989}
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Two long-standing JVM fixes {#h2-9-two-long-standing-jvm-fixes}
---------------------------------------------------------------

### [PR #4980](https://github.com/codenameone/CodenameOne/pull/4980) --- Iterative GC mark to fix iOS stack overflow on deep graphs {#h3-10-pr-4980-iterative-gc-mark-to-fix-ios-stack-overflow-on-deep-graphs}
...
### [PR #4985](https://github.com/codenameone/CodenameOne/pull/4985) --- Don't rely on C arg eval order in `PUTFIELD` / `MULTIANEWARRAY` {#h3-11-pr-4985-don-t-rely-on-c-arg-eval-order-in-putfield-multianewarray}
...
Hardware keyboard and mouse on iOS and Android --- [PR #4982](https://github.com/codenameone/CodenameOne/pull/4982) {#h2-12-hardware-keyboard-and-mouse-on-ios-and-android-pr-4982}
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Expanded CSS gradients and blurs --- [PR #4957](https://github.com/codenameone/CodenameOne/pull/4957){#https://github.com/codenameone/CodenameOne/pull/4957} {#h2-13-expanded-css-gradients-and-blurs-pr-4957}
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
On Metal: the community got there first {#h2-14-on-metal-the-community-got-there-first}
---------------------------------------------------------------------------------------
