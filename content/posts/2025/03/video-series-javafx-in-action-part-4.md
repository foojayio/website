...
slug: "video-series-javafx-in-action-part-4"
...
Mike Hearn: Conveyor, build self-updating desktop app packages {#h2-0-mike-hearn-conveyor-build-self-updating-desktop-app-packages}
-----------------------------------------------------------------------------------------------------------------------------------
...
Sven Reimers: JTaccuino, notebook application for Java developers {#h2-1-sven-reimers-jtaccuino-notebook-application-for-java-developers}
-----------------------------------------------------------------------------------------------------------------------------------------
...
Chris Newland: DemoFX and JitWatch {#h2-2-chris-newland-demofx-and-jitwatch}
----------------------------------------------------------------------------
