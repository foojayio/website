...
<img fetchpriority="high" decoding="async" class="size-medium wp-image-115882" style="margin-left: auto; margin-right: auto;" src="/images/posts/2025/03/clean-memory-from-finalize-to-cleaner/java_references-700x361.png" alt="Clean your Memory: From Finalize to Cleaner - Java Reference Hierarchy" width="700" height="361">
...
<img decoding="async" class="size-medium wp-image-115883" style="margin-left: auto; margin-right: auto;" src="/images/posts/2025/03/clean-memory-from-finalize-to-cleaner/JVM_threads_and_cleaner-700x338.jpg" alt="Clean your Memory: From Finalize to Cleaner - JVM Thread and the Common-Cleaner Thread" width="700" height="338">
