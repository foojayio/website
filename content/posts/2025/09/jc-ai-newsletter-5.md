...
authors:
  - "miro-wengner"
image: "/images/posts/2025/09/jc-ai-newsletter-5/ai-insider-1.png"
categories:
  - "Agile"
  - "AI"
  - "GenAI"
...
**article** : [Generating and editing images with Nano Banana in Java](https://glaforge.dev/posts/2025/09/09/calling-nano-banana-from-java/ "Generating and editing images with Nano Banana in Java")  
...
**article** : [Generating videos in Java with Veo 3](https://glaforge.dev/posts/2025/09/10/generating-videos-in-java-with-veo3/ "Generating videos in Java with Veo 3")  
**authors** : Guillaume Laforge  
**date** : 2025-09-10  
...
**article** : [Stochastic AI Agility: Breaking Cycles of Debt](https://foojay.io/today/stochastic-ai-agility-breaking-cycles-of-debt/ "Stochastic AI Agility: Breaking Cycles of Debt")  
...
**article** : [Conversation: LLMs and Building Abstractions](https://martinfowler.com/articles/convo-llm-abstractions.html "Conversation: LLMs and Building Abstractions")  
...
**article** : [Some thoughts on LLMs and Software Development](https://martinfowler.com/articles/202508-ai-thoughts.html "Some thoughts on LLMs and Software Development")  
...
**article** :[The Illusion of Diminishing Returns: Measuring Long Horizon Execution in LLMs](https://arxiv.org/abs/2509.09677 " The Illusion of Diminishing Returns: Measuring Long Horizon Execution in LLMs")  
...
**article** : [CDE: Curiosity-Driven Exploration for Efficient Reinforcement Learning in Large](https://arxiv.org/abs/2509.09675 "CDE: Curiosity-Driven Exploration for Efficient Reinforcement Learning in Large")  
...
**article** : [LoCoBench: A Benchmark for Long-Context Large Language Models in Complex Software Engineering](https://arxiv.org/abs/2509.09614 "LoCoBench: A Benchmark for Long-Context Large Language Models in Complex Software Engineering")  
...
**article** : [Towards Adaptive ML Benchmarks: Web-Agent-Driven Construction, Domain Expansion, and Metric Optimization](https://arxiv.org/abs/2509.09321 "Towards Adaptive ML Benchmarks: Web-Agent-Driven Construction, Domain Expansion, and Metric Optimization")  
...
**article** : [PATENTWRITER: A Benchmarking Study for Patent Drafting with LLMs](https://arxiv.org/abs/2507.22387 "PATENTWRITER: A Benchmarking Study for Patent Drafting with LLMs")  
...
**article** : [BEnchmarking LLMs for Ophthalmology (BELO) for Ophthalmological Knowledge and Reasoning](https://arxiv.org/abs/2507.15717 "BEnchmarking LLMs for Ophthalmology (BELO) for Ophthalmological Knowledge and Reasoning")  
...
**article** : [You Can Build Better AI Agents in Java Than Python](https://medium.com/@springrod/you-can-build-better-ai-agents-in-java-than-python-868eaf008493 "You Can Build Better AI Agents in Java Than Python")  
**authors** : Rod Johnson  
**date** : 2025-08-18  
...
**article** : [Research: Measuring Energy Consumption in Programming Languages for AI Applications](https://foojay.io/today/research-measuring-energy-consumption-in-programming-languages-for-ai-applications/ "Research: Measuring Energy Consumption in Programming Languages for AI Applications")  
**authors** : Miro Wengner  
**date** : 2025-09-15  
