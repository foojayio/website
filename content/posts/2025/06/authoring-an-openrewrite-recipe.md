...
![Recipe class diagram](/images/posts/2025/06/authoring-an-openrewrite-recipe/recipe-class-diagram-1024x974.png)

Here's an excerpt of the `K` class to complement the previous diagram:

![Kotlin-specific class diagram](/images/posts/2025/06/authoring-an-openrewrite-recipe/k-class-diagram-1024x625.png)
...
![Diagram of classes involved in tests](/images/posts/2025/06/authoring-an-openrewrite-recipe/test-class-diagram-1024x457.png)
