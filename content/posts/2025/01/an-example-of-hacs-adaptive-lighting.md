...
<img fetchpriority="high" decoding="async" class="aligncenter wp-image-115066 size-medium" src="/images/posts/2025/01/an-example-of-hacs-adaptive-lighting/ha-ui-search-hacs-integration-700x288.jpeg" alt="Search for HACS" width="700" height="288">

<br />

Once you install it, it appears in the integration list.

<img decoding="async" class="aligncenter size-medium wp-image-115067" src="/images/posts/2025/01/an-example-of-hacs-adaptive-lighting/ha-ui-integration-hacs-535x510.jpeg" alt="HAC installed" width="535" height="510">
...
<img decoding="async" class="aligncenter size-medium wp-image-115068" src="/images/posts/2025/01/an-example-of-hacs-adaptive-lighting/adaptive-lighting-companion-webapp-700x504.jpeg" alt="Adaptive Lighting companion webapp" width="700" height="504">
...
<img loading="lazy" decoding="async" class="aligncenter size-medium wp-image-115069" src="/images/posts/2025/01/an-example-of-hacs-adaptive-lighting/ha-ui-hacs-adaptive-lighting-700x370.jpeg" alt="Adaptive Lighting added to HACS" width="700" height="370">

<br />

Home Assistant features the Adaptive Lighting integration at this stage, ready to be configured and used.

<img loading="lazy" decoding="async" class="aligncenter size-medium wp-image-115070" src="/images/posts/2025/01/an-example-of-hacs-adaptive-lighting/ha-ui-hacs-integration-adaptive-lighting-628x510.jpeg" alt="Adaptive Lighting integration" width="628" height="510">
...
![Configure the Adaptive Lighting service](/images/posts/2025/01/an-example-of-hacs-adaptive-lighting/ha-ui-hacs-configure-service-adaptive-lighting-603x1024.jpeg)
...
<img loading="lazy" decoding="async" class="aligncenter size-medium wp-image-115072" src="/images/posts/2025/01/an-example-of-hacs-adaptive-lighting/ha-ui-hacs-service-adaptive-lighting-538x510.jpeg" alt="Adaptive Lighting configured service" width="538" height="510">
