...
What are the Application Observability Code Challenges? {#h2-0-what-are-the-application-observability-code-challenges}
----------------------------------------------------------------------------------------------------------------------
...
What do the code challenges look like? {#h2-2-what-do-the-code-challenges-look-like}
------------------------------------------------------------------------------------
...
![Application Observability flow](/images/posts/2025/01/challenge-yourself-with-application-observability-code-challenges/flow.png)

Your own stack {#h2-3-your-own-stack}
-------------------------------------
...
![Application Observability flow with own stack](/images/posts/2025/01/challenge-yourself-with-application-observability-code-challenges/flow_with_own_stack.png)

Online environment(s) {#h2-4-online-environment-s}
--------------------------------------------------
...
The first challenge {#h2-5-the-first-challenge}
-----------------------------------------------
...
🛠️ How to Get Started {#h2-6-how-to-get-started}
-------------------------------------------------
...
Challenge details {#h2-7-challenge-details}
-------------------------------------------
...
![Setup](/images/posts/2025/01/challenge-yourself-with-application-observability-code-challenges/full_setup.png)

After running one of the scripts you can get more details in a Grafana dashboard like this:  
![K6 dashboard](/images/posts/2025/01/challenge-yourself-with-application-observability-code-challenges/k6_highload_dashboard.png)
