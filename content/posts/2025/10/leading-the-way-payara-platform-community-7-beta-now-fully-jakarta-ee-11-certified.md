...
This milestone makes Payara the first vendor to achieve full Jakarta EE 11 certification across all profiles, underscoring our commitment to delivering an innovative, production-ready runtime for the enterprise Java community.

The Jakarta EE 11 certification was achieved by successfully passing the Jakarta EE Technology Compatibility Kit (TCK), also referred to as the Compatibility Test Suite (CTS). This verifies that an implementation conforms to the Jakarta EE specifications across all profiles.
...
Why Jakarta EE 11 Certification Matters for Payara Users {#h2-0-why-jakarta-ee-11-certification-matters-for-payara-users}
-------------------------------------------------------------------------------------------------------------------------

Certification isn't just a badge - it's a promise. For Payara Platform Community users, this achievement means you can:

* Build on the latest enterprise Java standards with confidence.
* Adopt new features early while relying on the stability of a certified runtime.
...
Not a Payara Platform Community User? No Problem! {#h2-1-not-a-payara-platform-community-user-no-problem}
---------------------------------------------------------------------------------------------------------
...
Jakarta EE 11: The Future of Enterprise Java {#h2-2-jakarta-ee-11-the-future-of-enterprise-java}
------------------------------------------------------------------------------------------------
...
Jakarta EE 11 Certification Availability {#h2-3-jakarta-ee-11-certification-availability}
-----------------------------------------------------------------------------------------
...
Payara's Role in the Community {#h2-4-payara-s-role-in-the-community}
---------------------------------------------------------------------
...
Also, as Payara Platform Community is a truly collaborative project built with and for developers, we welcome your contributions and insights. By participating, you're not only improving the Payara Platform, but also contributing back to the wider Jakarta EE community. Every contribution strengthens the enterprise Java platform and accelerates innovation for all developers.
