...
authors:
  - "karin-lauria"
image: "feff67d2-great-data-reimagination-1024x576-1.jpg"
categories:
  - "Databases"
  - "Machine Learning"
  - "Mongo"
...
[Matryoshka Embeddings: Smarter Embeddings with Voyage AI](https://www.mongodb.com/company/blog/technical/matryoshka-embeddings-smarter-embeddings-with-voyage-ai?utm_source=the+new+stack&utm_medium=referral&utm_campaign=tns+platform&utm_content=sponsor+module)

[14 July 2025](https://www.mongodb.com/company/blog/technical/matryoshka-embeddings-smarter-embeddings-with-voyage-ai?utm_source=the+new+stack&utm_medium=referral&utm_campaign=tns+platform&utm_content=sponsor+module)[Improving Industrial Safety with Game Theory and MongoDB
14 July 2025](https://www.mongodb.com/company/blog/innovation/improving-industrial-safety-game-theory-mongodb?utm_source=the+new+stack&utm_medium=referral&utm_campaign=tns+platform&utm_content=sponsor+module)[Don't Just Build Agents, Build Memory-Augmented AI Agents
9 July 2025](https://www.mongodb.com/company/blog/technical/dont-just-build-agents-build-memory-augmented-ai-agents?utm_source=the+new+stack&utm_medium=referral&utm_campaign=tns+platform&utm_content=sponsor+module)
...
1. [The Great Data Reimagination: From Static to Agile in the AI Era](https://thenewstack.io/the-great-data-reimagination-from-static-to-agile-in-the-ai-era/)
2. [Kubernetes Finally Solves Its Biggest Problem: Managing Databases](https://thenewstack.io/kubernetes-finally-solves-its-biggest-problem-managing-databases/)
3. [Mark Cache: The ClickHouse Speed Hack You're Not Using (Yet)](https://thenewstack.io/mark-cache-the-clickhouse-speed-hack-youre-not-using-yet/)
4. [Building Real-Time SMS, WhatsApp and Slack Alerts](https://thenewstack.io/building-real-time-sms-whatsapp-and-slack-alerts/)
5. [High-Stakes Data Migrations: Lessons Learned](https://thenewstack.io/lessons-learned-leading-high-stakes-data-migrations/)
