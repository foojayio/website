...
authors:
  - "frankdelporte"
image: "/images/posts/2025/07/when-readynow-can-only-compile-on-traffic-loads/Favicon-3-2.png"
categories:
  - "Java"
  - "Performance"
tags:
...
Compilation only happens on traffic loads {#Compilation-Only-Happens-on-Traffic-Loads}
--------------------------------------------------------------------------------------
...
![](/images/posts/2025/07/when-readynow-can-only-compile-on-traffic-loads/readynow-compile-queus.jpg)

ReadyNow waits for class loading {#ReadyNow-Waits-for-Class-Loading}
--------------------------------------------------------------------
...
### Calling the identified code {#Calling-the-Identified-Code}
...
Example with Spring Petclinic {#Example-with-Spring-Petclinic}
--------------------------------------------------------------
...
### Run without a ReadyNow profile {#Run-without-ReadyNow-profile}
...
![](/images/posts/2025/07/when-readynow-can-only-compile-on-traffic-loads/readynow-compile-queus-no-profile-1024x536.jpg)

### Run with a ReadyNow profile {#Run-with-ReadyNow-Profile}
...
![](/images/posts/2025/07/when-readynow-can-only-compile-on-traffic-loads/readynow-compile-queus-with-profile.avif)

Generational ReadyNow profiles {#h-generational-readynow-profiles}
------------------------------------------------------------------
...
<figure class="wp-block-gallery has-nested-images columns-default is-cropped wp-block-gallery-1 is-layout-flex wp-block-gallery-is-layout-flex">
 <figure class="wp-block-image size-large">
  <img loading="lazy" decoding="async" width="1024" height="508" data-id="116430" src="/images/posts/2025/07/when-readynow-can-only-compile-on-traffic-loads/gc-with-readynow-gen-1-1024x508.png" alt="" class="wp-image-116430">
 </figure>
 <figure class="wp-block-image size-large">
  <img loading="lazy" decoding="async" width="1024" height="508" data-id="116429" src="/images/posts/2025/07/when-readynow-can-only-compile-on-traffic-loads/gc-with-readynow-gen-2-1024x508.png" alt="" class="wp-image-116429">
 </figure>
 <figure class="wp-block-image size-large">
  <img loading="lazy" decoding="async" width="1024" height="508" data-id="116428" src="/images/posts/2025/07/when-readynow-can-only-compile-on-traffic-loads/gc-with-readynow-gen-3-1024x508.png" alt="" class="wp-image-116428">
 </figure>
</figure>
