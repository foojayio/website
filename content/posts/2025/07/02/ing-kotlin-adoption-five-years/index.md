...
![The share of empty repos inside our org](3-700x467.webp)
...
![Filtering JVM repos from the active repository baseAbout a third of our repositories are JVM](4-700x353.webp)
...
![Flavors of language across our JVM repos](7-700x467.webp)
...
![Activity trend per JVM flavor over time](8-700x467.webp)
...
![Trend of Kotlin activity in volume over time, for our inner source code](10-700x467.webp)
