...
![](PlatformArchitecture-1024x516.png) ***Fig 1:**Scala is the glue for the Quantexa Platform and helps integrate with customer ecosystems*.
...
![Scala Code](Scala1-1024x594.png) ***Fig 2:*** *In this code, our 'Project Example', we join two datasets into a single nested dataset and collect some population metrics.*
