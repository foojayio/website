...
Why GC Tuning Matters on Arm {#h2-0-why-gc-tuning-matters-on-arm}
-----------------------------------------------------------------
...
### OpenJDK Version {#h3-1-openjdk-version}
...
### Choosing the Right Garbage Collector {#h3-2-choosing-the-right-garbage-collector}
...
[![table comparison different garbage collectors in java](/images/posts/2025/04/optimizing-the-garbage-collector-when-migrating-cloud-workloads/comparison-table-700x431.png)](https://learn.arm.com/learning-paths/servers-and-cloud-computing/java-gc-tuning/different_gcs/)
...
### Heap Size and GC Pause Time {#h3-3-heap-size-and-gc-pause-time}
...
### Adaptive Heap Sizing {#h3-4-adaptive-heap-sizing}
...
### Closing the feedback loop {#h3-5-closing-the-feedback-loop}
...
Developer Education for the Java Community {#h2-6-developer-education-for-the-java-community}
---------------------------------------------------------------------------------------------
...
### Need Assistance from Experts? {#h3-7-need-assistance-from-experts}
