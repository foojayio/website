...
[Microsoft Security Copilot](http://https://www.microsoft.com/en-us/security/blog/2023/03/28/introducing-microsoft-security-copilot-empowering-defenders-at-the-speed-of-ai/ "Microsoft Security Copilot"): An AI assistant for cybersecurity analysts.

[Google/Mandiant](http://https://nationalcioreview.com/articles-insights/extra-bytes/gemini-ai-integrates-with-mandiant-and-virustotal-in-googles-new-cybersecurity-initiative/#:~:text=By%20merging%20Mandiant%27s%20and%20VirusTotal%27s,%2C%20quickly%20reverse%2Dengineers%20malware. "Google/Mandiant"): Integrating Gemini models into threat detection.

[Darktrace](http://https://www.darktrace.com/en/ "Darktrace"): Using unsupervised learning and generative models to detect anomalies in enterprise environments.

#### Responsible AI \& Governance:

[IBM AI FactSheets](http://https://www.ibm.com/docs/en/software-hub/5.1.x?topic=services-ai-factsheets "IBM AI FactSheets"): Transparency tooling for datasets and models.

[Hugging Face Model Cards](http://https://huggingface.co/docs/hub/model-cards "Hugging Face Model Card"): for ethical and usage documentation.

[Scale AI](http://https://scale.com/ "Scale AI"): Offers evaluation frameworks and safety testing for AI models.
...
If you want to learn more visit my [10xInsights news letter](https://www.linkedin.com/newsletters/10xinsights-7242495495711899650) or related articles at [JavaPro](https://javapro.io/2025/04/01/move-fast-break-laws-ai-open-source-and-devs-part-1/http:// "JavaPro")
