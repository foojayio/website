...
<img fetchpriority="high" decoding="async" class="aligncenter wp-image-115479 size-medium" src="/images/posts/2025/02/remote-development-made-simple-with-devpod/devpod-home-700x490.webp" alt="DevPod Home screen" width="700" height="490">
...
<img decoding="async" class="aligncenter size-medium wp-image-115480" src="/images/posts/2025/02/remote-development-made-simple-with-devpod/devpod-configure-provider-700x245.webp" alt="Configuring a new DevPod provider" width="700" height="245">
...
<img decoding="async" class="aligncenter size-medium wp-image-115481" src="/images/posts/2025/02/remote-development-made-simple-with-devpod/devpod-create-workspace-576x510.webp" alt="Starting a new DevPod workspace" width="576" height="510">

<br />

At this point, DevPod will download the image and open the project running in OrbStack in IntelliJ.

<img loading="lazy" decoding="async" class="aligncenter size-medium wp-image-115482" src="/images/posts/2025/02/remote-development-made-simple-with-devpod/intellij-via-gateway-700x437.webp" alt="Running IntelliJ via the JetBrains Gateway" width="700" height="437">
...
<img loading="lazy" decoding="async" class="aligncenter size-medium wp-image-115483" src="/images/posts/2025/02/remote-development-made-simple-with-devpod/dl-jetbrains-client-700x145.webp" alt="Downloading the JetBrains client" width="700" height="145">
