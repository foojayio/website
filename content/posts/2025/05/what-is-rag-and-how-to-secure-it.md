...
How RAG Works {#h2-1-how-rag-works}
-----------------------------------
...
### 2. Generation {#h3-3-2-generation}
...
Security implications of using RAG {#h2-4-security-implications-of-using-rag}
-----------------------------------------------------------------------------
...
### Prompt injection through retrieved content {#h3-5-prompt-injection-through-retrieved-content}
...
### Data poisoning {#h3-6-data-poisoning}
...
### Access control gaps in retrieval {#h3-7-access-control-gaps-in-retrieval}
...
### Leaking PII to third-party models {#h3-8-leaking-pii-to-third-party-models}
...
### Caching risks and session bleed {#h3-9-caching-risks-and-session-bleed}
...
### Contradictory or low-quality information {#h3-10-contradictory-or-low-quality-information}
...
Proactive and remediation strategies for securing RAG {#h2-11-proactive-and-remediation-strategies-for-securing-rag}
--------------------------------------------------------------------------------------------------------------------
...
### Sanitize retrieved content {#h3-12-sanitize-retrieved-content}
...
### Enforce access control on retrieval {#h3-13-enforce-access-control-on-retrieval}
...
### Segment and scope your index {#h3-14-segment-and-scope-your-index}
...
### Prevent regular vulnerabilities in code and dependencies. {#h3-15-prevent-regular-vulnerabilities-in-code-and-dependencies}
...
### Use moderation and filters on data sources {#h3-16-use-moderation-and-filters-on-data-sources}
...
### Regularly audit your data {#h3-17-regularly-audit-your-data}
...
### Avoid unfiltered cache responses {#h3-18-avoid-unfiltered-cache-responses}
...
### Review your LLM model strategy. {#h3-19-review-your-llm-model-strategy}
...
RAG is critical, but is also an attack vector. {#h2-20-rag-is-critical-but-is-also-an-attack-vector}
----------------------------------------------------------------------------------------------------
