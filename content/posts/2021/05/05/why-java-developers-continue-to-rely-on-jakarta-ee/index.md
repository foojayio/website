...
* [Apache Tomcat](https://tomcat.apache.org/) implements several Jakarta EE specifications
* [Eclipse Jetty](https://www.eclipse.org/jetty/) is a certified implementation of Jakarta Servlet 5.0
* [Spring Boot](https://spring.io/projects/spring-boot) embeds Eclipse Jetty or Apache Tomcat as a runtime
...
These insights are just a few of the reasons leading Java developers remain committed to Jakarta EE. For the complete story, [download the white paper](https://outreach.jakartaee.org/white-paper-java-applications).

Visit the [Jakarta EE website](https://jakarta.ee/) to learn more about Jakarta EE and explore the [Jakarta EE specifications](https://jakarta.ee/specifications/).
