...
What is the Project Object Model? {#h2-0-what-is-the-project-object-model}
--------------------------------------------------------------------------
...
How does Maven interact with a POM? {#h2-1-how-does-maven-interact-with-a-pom}
------------------------------------------------------------------------------
...
### What is an effective POM? {#h3-2-what-is-an-effective-pom}
...
### How does Maven assemble the effective POM? {#h3-3-how-does-maven-assemble-the-effective-pom}
...
The layers explained {#h2-4-the-layers-explained}
-------------------------------------------------

Going through the layers:

### Maven Internal Defaults {#h3-5-maven-internal-defaults}
...
### Maven Super POM {#h3-6-maven-super-pom}
...
### Maven Global Settings {#h3-7-maven-global-settings}
...
### Maven User Settings {#h3-8-maven-user-settings}
...
### Parent / Bill-of-Material POMs {#h3-9-parent-bill-of-material-poms}
