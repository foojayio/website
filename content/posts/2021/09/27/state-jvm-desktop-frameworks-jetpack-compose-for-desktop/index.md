...
![Basic Compose window](basic-compose.jpg)
...
![derived state compose](derived-state-compose.jpg)
...
*Originally published at [A Java Geek](https://blog.frankel.ch/state-jvm-desktop-frameworks/5/) on February 7th 2021*
