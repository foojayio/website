...
![Default Changelist - no files selected](intellij-idea-default-changelist-nothing-selected.png)

From there, if you want to select the whole file to be committed, you can select the checkbox to the left of the filename:

![Default Changelist - one file selected](intellij-idea-default-changelist-one-selected.png)
...
![Default Changelist - revert file](intellij-idea-default-changelist-revert-staging.png)
