...
<figure class="alignleft size-large">
 <img fetchpriority="high" decoding="async" width="174" height="313" src="/images/posts/2021/04/beginning-javafx-with-intellij/duke-intellij-shirt.png" alt="" class="wp-image-32843">
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/IntelliJ-NewProject.png) Figure 1. Three ways to create a Java project.
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/01_NewProject.png) Figure 2. Select Java as the project type.
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/Add_JDK.png)
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/zuluFX_home_links.png) Figure 4. ZuluFX Java JDK that includes JavaFX modules.
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/HelloWorldFX.png) Figure 5. Naming Project to be created in a projects directory.
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/Change-Language-level.png) Figure 6. Project language level selection. 14 (Preview) should be selected.

**Step 7:** Unmark the '**src**' directory as the source root as shown below in figure 7.
![](/images/posts/2021/04/beginning-javafx-with-intellij/Unmark-as-Source-Root.png) Figure 7. Unmark as Source Root.
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/Create-a-module-directory.png) Figure 8. Create a module directory using the reverse domain name convention. ![](/images/posts/2021/04/beginning-javafx-with-intellij/NewDirectory.png) Figure 9. The name of the new directory for the project module.
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/Mark-as-source-root.png) Figure 10. Marking the module directory as the **Sources Root**.
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/Creating-a-module-info.png) Figure 11. Creating a JPMS module-info.java file for the JavaFX application.
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/Create-a-package.png) Figure 12. Creating directories of the package namespace.

After selecting the menu options you will enter the package name **com.mycompany.helloworld** and hit **Enter** as shown below:
![](/images/posts/2021/04/beginning-javafx-with-intellij/Newpackagename.png) Figure 13. package name **com.mycompany.helloworld**

Once created you should see the following folder created under the module name as shown in figure 14 below:
![](/images/posts/2021/04/beginning-javafx-with-intellij/packagenamespace-directory.png) Figure 14. Package name space under module directory.
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/Creating-JavaFX-Main.png) Figure 15. Creating the JavaFX main application Java file.
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/JavaFXApplication.png) Figure 16. Name of Java class and the class type.
...
<figure class="wp-block-image size-large is-resized is-style-default">
 ...
 <figcaption class="wp-element-caption">
  Figure 17. HelloWorld.java file generated by IntelliJ.
 </figcaption>
</figure>
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/Initial-Run.png)   
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/Final-output-App.png) Figure 20. The output of the execution of HelloWorld JavaFX application.
...
**Step 1:**Create a New Project
![IntelliJ IDEA New Project](/images/posts/2021/04/beginning-javafx-with-intellij/IntelliJ-NewProject.png) Figure 21. New Project
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/01-New-Project-Maven.png) Figure 22. Selecting Maven as a Project type and Selecting a JDK
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/02-New-Project-artifact-coord.png) Figure 23. Naming the project and Maven coordinates

Click on **Finish**.

The project will output as shown below in Figure 24.
![](/images/posts/2021/04/beginning-javafx-with-intellij/03-Empty-Project-1024x357.png) Figure 24. An empty Maven Java project.
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/06-Language-Level.png) Figure 25. Setting Language Level for Project
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/07-Language-Level2.png) Figure 26. Setting Language Level for Modules
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/08-Javafolder.png) Figure 29. Creating a new module-info.java file.
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/10-Maven-Reload-project.png) Figure 31. Maven tab to reload the project plugins and dependencies.
...
![](/images/posts/2021/04/beginning-javafx-with-intellij/Final-output-App.png) Figure 32. Maven executed Hello World application
