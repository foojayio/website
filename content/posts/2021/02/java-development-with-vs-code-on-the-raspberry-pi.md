...
![](/images/posts/2021/02/java-development-with-vs-code-on-the-raspberry-pi/visualstudiocode-download.png) Visual Studio Code dowload page with ARM 32bit and 64bit version
...
<figure class="wp-block-gallery columns-2 is-cropped wp-block-gallery-1 is-layout-flex wp-block-gallery-is-layout-flex">
 <ul class="blocks-gallery-grid">
  <li class="blocks-gallery-item">
   <figure>
    <img decoding="async" width="930" height="1024" src="/images/posts/2021/02/java-development-with-vs-code-on-the-raspberry-pi/programming-tools-in-raspberry-pi-os-930x1024.png" alt="" data-id="37814" data-full-url="https://foojay.io/wp-content/uploads/2021/02/programming-tools-in-raspberry-pi-os.png" data-link="https://foojay.io/?attachment_id=37814" class="wp-image-37814">
   </figure></li>
  <li class="blocks-gallery-item">
   <figure>
    <img decoding="async" width="1024" height="770" src="/images/posts/2021/02/java-development-with-vs-code-on-the-raspberry-pi/vsc-on-raspberry-pi-1024x770.png" alt="" data-id="37813" data-full-url="https://foojay.io/wp-content/uploads/2021/02/vsc-on-raspberry-pi.png" data-link="https://foojay.io/?attachment_id=37813" class="wp-image-37813">
   </figure></li>
 </ul>
</figure>
...
![](/images/posts/2021/02/java-development-with-vs-code-on-the-raspberry-pi/visualstudiocode-64bit-java-extension-pack.png) Visual Studio Code running on Raspberry Pi OS (64bit)
...
![](/images/posts/2021/02/java-development-with-vs-code-on-the-raspberry-pi/visualstudiocode-64bit-java-testing.png) JavaFX demo application started by Visual Studio Code on the Raspberry Pi
