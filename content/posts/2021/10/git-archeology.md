...
[![Photo by Marcus Lange from Pexels](/images/posts/2021/10/git-archeology/unearth.jpg)](https://www.instagram.com/marcos.lange77/)
...
![IntelliJ VCS Annotation Options](/images/posts/2021/10/git-archeology/intellij_options.png)
...
![GitHub prior commits](/images/posts/2021/10/git-archeology/github_prior.png)

Similarly, IntelliJ-based IDEs allow you to do the same using "Annotate Previous Revision":

![IntelliJ Annotate Previous Commit](/images/posts/2021/10/git-archeology/annotate_previous.png)

In case you're using Visual Studio Code, the excellent "GitLense" extension offers similar commands:

![Visual Studio Code Show Previous Commit](/images/posts/2021/10/git-archeology/gitlense_previous.png)
...
![IntelliJ Ignoring Changes](/images/posts/2021/10/git-archeology/blame_ignore_intellij.png)
