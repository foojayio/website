---
title: "Understanding Apache Maven (Part 6): POM Reference | Foojay.io Today"
...
### Project Model `modelVersion` {#h3-1-project-model-modelversion}
...
### Project Coordinates {#h3-2-project-coordinates}
...
### Output `packaging` {#h3-3-output-packaging}
...
### Project `name`, `description` and `url` {#h3-4-project-name-description-and-url}
...
### Relationship `modules` {#h3-5-relationship-modules}
...
### Source Control Management `scm` {#h3-6-source-control-management-scm}
...
### Dependency \& Plugin Artifact Search `repositories` and `pluginRepositories` {#h3-7-dependency-plugin-artifact-search-repositories-and-pluginrepositories}
...
### Artifact Publishing `distributionManagement` {#h3-8-artifact-publishing-distributionmanagement}
...
### Issue Tracking \& Continuous Integration `issueManagement` and `ciManagement` {#h3-9-issue-tracking-continuous-integration-issuemanagement-and-cimanagement}
...
### POM Properties `properties` {#h3-10-pom-properties-properties}
...
### Dependency Management `dependencyManagement` {#h3-11-dependency-management-dependencymanagement}
...
### Project Dependencies `dependencies` {#h3-12-project-dependencies-dependencies}
...
### The build instructions {#h3-13-the-build-instructions}
...
Additional links {#h2-14-additional-links}
------------------------------------------
