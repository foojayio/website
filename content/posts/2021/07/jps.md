...
<pre class="EnlighterJSRAW" data-enlighter-language="generic">jps [options] pid

options:    This represents the jps command-line options.
pid:        The process ID for which the information specified by the options is to be printed.</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic">java -version
openjdk version "17-internal" 2021-09-14
OpenJDK Runtime Environment (build 17-internal+0-adhoc.vipin.jdk)
OpenJDK 64-Bit Server VM (build 17-internal+0-adhoc.vipin.jdk, mixed mode)</pre>

We are running the Java process using the following command. For the rest of this article we will use jps on this process.

<pre class="EnlighterJSRAW" data-enlighter-language="generic">java -XX:ConcGCThreads=6 -Xmx256m -Xms8m -Xss256k Test argument1 argument2</pre>

#### Print Java process ids

Following command shows process ids.

<pre class="EnlighterJSRAW" data-enlighter-language="generic">jps -q</pre>

Output:

<pre class="EnlighterJSRAW" data-enlighter-language="generic">2468
10660
7067
7470
10366
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic">jps</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic">jps -l</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic">jps -m</pre>
...
10366 Test argument1 argument2</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic">jps -v</pre>

Output:

<pre class="EnlighterJSRAW" data-enlighter-language="generic">2468 -Djava.library.path=/tmp/.mount_jetbraH5N0hQ -Xmx256m -Xms8m -Xss256k -XX:+UseStringDeduplication -XX:+UseCompressedOops -XX:+UseSerialGC -Djava.awt.headless=true -Djava.net.preferIPv4Stack=true -Djdk.lang.processReaperUseDefaultStackSize=true vfprintf exit abort -DTOOLBOX_VERSION=1.20.7940
...
10366 Test -XX:ConcGCThreads=6 -Xmx256m -Xms8m -Xss256k</pre>
