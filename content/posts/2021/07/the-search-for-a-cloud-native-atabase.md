...
description: "Automation is often the final milestone to be achieved, but running databases in Kubernetes can actually help us progress toward this goal."
canonical: "https://k8ssandra.io/blog/articles/the-search-for-a-cloud-native-database/"
authors:
  - "cedrick-lunven"
  - "jeff-carpenter"
...
What is Cloud-Native? {#h2-0-what-is-cloud-native}
--------------------------------------------------
...
![](/images/posts/2021/07/the-search-for-a-cloud-native-atabase/cncf-landscape-db_hu725d4d7b3d105a5db9f2db4c635f96d6_353693_800x0_resize_catmullrom_2.png)
...
Why should I care if my database is cloud-native? {#h2-1-why-should-i-care-if-my-database-is-cloud-native}
----------------------------------------------------------------------------------------------------------
...
What are the characteristics of a cloud-native database? {#h2-2-what-are-the-characteristics-of-a-cloud-native-database}
------------------------------------------------------------------------------------------------------------------------
...
What's a good example of a cloud-native database? {#h2-3-what-s-a-good-example-of-a-cloud-native-database}
----------------------------------------------------------------------------------------------------------
...
Does a cloud-native database have to run on Kubernetes? {#h2-4-does-a-cloud-native-database-have-to-run-on-kubernetes}
----------------------------------------------------------------------------------------------------------------------
...
### Containerization {#h3-5-containerization}
...
### Automated Operations {#h3-7-automated-operations}
...
Conclusion and what's next {#h2-8-conclusion-and-what-s-next}
-------------------------------------------------------------
