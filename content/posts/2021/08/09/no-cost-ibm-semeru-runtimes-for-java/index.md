...
#### Download [IBM Semeru Runtimes](https://www.ibm.com/semeru-runtimes/downloads "IBM Semeru Runtimes") to get started today.
...
Additionally, we helped to found and have supported the AdoptOpenJDK community as it grew to become one of the top providers of no-cost, OpenJDK-based binaries for Java developers. We continue to support this community at its [new home](https://developer.ibm.com/languages/java/blogs/ibm-joins-eclipse-adoptium-and-offers-free-certified-jdks-with-eclipse-openj9/ "new home") in the Eclipse Adoptium project.
