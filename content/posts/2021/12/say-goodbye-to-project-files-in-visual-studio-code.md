---
title: "Say Goodbye to Project Files in Visual Studio Code | Foojay.io Today"
...
A Long-Awaited Change {#h2-0-a-long-awaited-change}
---------------------------------------------------
...
![](/images/posts/2021/12/say-goodbye-to-project-files-in-visual-studio-code/architecturepng.png)
...
Option 1: Use Symbolic Link (Unsuccessful) {#h2-1-option-1-use-symbolic-link-unsuccessful}
------------------------------------------------------------------------------------------
...
Option 2: Use Eclipse Linked Resources (Unsuccessful) {#h2-2-option-2-use-eclipse-linked-resources-unsuccessful}
----------------------------------------------------------------------------------------------------------------
...
![](/images/posts/2021/12/say-goodbye-to-project-files-in-visual-studio-code/mechanism.jpg)

Principles of Unmanaged Folder Implementation {#h2-3-principles-of-unmanaged-folder-implementation}
---------------------------------------------------------------------------------------------------
...
Discovering the "Silver Bullet" {#h2-4-discovering-the-silver-bullet}
---------------------------------------------------------------------
...
Solution: File System Provider {#h2-5-solution-file-system-provider}
--------------------------------------------------------------------
...
Feedback and Suggestions {#h2-7-feedback-and-suggestions}
---------------------------------------------------------
