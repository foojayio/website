...
<pre class="EnlighterJSRAW" data-enlighter-language="java" data-enlighter-theme="dracula">MessageProducer producer = session.createProducer( destination );
...
<pre class="EnlighterJSRAW" data-enlighter-language="java" data-enlighter-theme="dracula">final Routing routing = wire.methodWriter(Routing.class);
routing.to("Italy").product(new Product("Coffee"));
routing.to("France").product(new Product("Cheese"));
routing.to("America").product(new Product("Popcorn"));</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="dracula">class Product extends SelfDescribingMarshallable {
        String name;
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="dracula">@FunctionalInterface
interface Routing {
...
<pre class="EnlighterJSRAW" data-enlighter-language="java" data-enlighter-theme="dracula">final Map&lt;String, ProductHandler&gt; destinationMap = new HashMap&lt;&gt;();
...
<pre class="EnlighterJSRAW" data-enlighter-language="java" data-enlighter-theme="dracula">private final Wire wire = new TextWire(Bytes.allocateElasticOnHeap());
</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="dracula">System.out.println(wire);</pre>

The following will get logged to the console:

<pre class="EnlighterJSRAW" data-enlighter-language="java" data-enlighter-theme="dracula">to: Italy
product: {
  name: Coffee
}
...
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="dracula">CLASS_ALIASES.addAlias(Product.class, ProductHandler.class);</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="dracula">private final Wire wire = new BinaryWire(new HexDumpBytes());
</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="dracula">System.out.println(wire.bytes().toHexString())
</pre>

Chronicle Wire will automatically add in the #comment on the right-hand side.

<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="dracula">21 00 00 00                                     # msg-length
...
80 0d                                           # Product
   c4 6e 61 6d 65                                  # name:
   e7 50 6f 70 63 6f 72 6e                         # Popcorn</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="dracula">MethodReader reader = wire.methodReader((Routing) destinationMap::get);
</pre>

To continuously process messages using the current thread, the code would look like this:

<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="dracula">for (; ; ) {
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="dracula">boolean success;
do {
    // true if a message was read
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="dracula">Sends the product to Italy, product=!Product {
  name: Coffee
}
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic" data-enlighter-theme="dracula">"to":"websocketClient1","product":{"name":"Coffee"}
"to":"websocketClient2","product":{"name":"Cheese"}
"to":"websocketClient3","product":{"name":"Popcorn"}</pre>
