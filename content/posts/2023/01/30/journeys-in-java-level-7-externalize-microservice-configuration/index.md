...
authors:
  - "jennifer-reif"
image: "unsplash-canyon-road-bridge-scaled.jpeg"
categories:
  - "Databases"
  - "Graph"
  - "Java Core"
...
![microservices level7](microservices-level7.png)
...
![springio configserver](springio-configserver.png)
...
![config server test](config-server-test.png)
...
![microservices lvl7 results](microservices-lvl7-results.png)

Figure 3. Find 1000 reviews

![microservices lvl7 results book](microservices-lvl7-results-book.png)
