...
![A diagram of how the new interfaces related to sequence collections are retrofitted into the existing collections type hierarchy.](sequenced-collections-diagram-1024x569.png) Image from [JEP 431](https://openjdk.org/jeps/431#Retrofitting)
