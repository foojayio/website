...
![List Builder, FXComponents](/images/posts/2023/09/new-fxcomponents-library-released/List-Builder.gif)

### Reordable ListView {#h3-2-reordable-listview}

A ListView that the user can reorder by drag and dropping each cell.
![](/images/posts/2023/09/new-fxcomponents-library-released/Reordable-ListView.gif)
...
![](/images/posts/2023/09/new-fxcomponents-library-released/Blocking-ProgressBar.gif)

#### Determinate

![](/images/posts/2023/09/new-fxcomponents-library-released/Blocking-ProgressBar-determinate.gif)
