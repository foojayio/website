...
![Maven tool window](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/maven-tool-window.png)

Open the Dependency Analyzer {#h2-0-open-the-dependency-analyzer}
-----------------------------------------------------------------
...
![Analyze Dependencies button](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/analyze-dependencies-button.png)
...
![Analyze Dependencies](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/analyze-dependencies.png)

We can hide all tool windows (**⇧⌘F12** on macOS / **Control+Shift+F12** on Windows/Linux), so we can focus on the dependencies.

![Dependency Analyzer](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/dependency-analyzer.png)

Viewing dependencies in the Dependency Analyzer {#h2-1-viewing-dependencies-in-the-dependency-analyzer}
-------------------------------------------------------------------------------------------------------
...
![Show as Tree](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/show-as-tree.png)

We can also click the **View Options** button and toggle **Show GroupId**, to show the GroupId for dependencies or not.

![View Options](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/view-options.png)

Finding a specific dependency {#h2-2-finding-a-specific-dependency}
-------------------------------------------------------------------
...
![Search for a specific dependency](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/search.png)

Finding conflicts {#h2-3-finding-conflicts}
-------------------------------------------
...
![Show Conflicts Only button](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/show-conflicts-only-button.png)

![Show Conflicts Only result](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/show-conflicts-only-result.png)

![Omitted for conflict](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/omitted-for-conflict.png)

Selecting scopes {#h2-4-selecting-scopes}
-----------------------------------------
...
![Show Maven Scopes](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/maven-scopes.png)

When we open the Dependency Analyzer from the Gradle tool window, the list of scopes will contain Gradle scopes.

![Show Gradle Scopes](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/gradle-scopes.png)

More context {#h2-5-more-context}
---------------------------------
...
![Open Maven Config](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/open-maven-config.png)

If you are using IntelliJ IDEA Ultimate, you can also view your dependencies as a diagram.

Show Diagrams {#h2-6-show-diagrams}
-----------------------------------
...
![Diagrams | Show Diagrams](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/show-diagram.png)

![Gradle Dependencies](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/gradle-dependencies.png)

Zoom in {#h2-7-zoom-in}
-----------------------
...
![Dependency Diagram](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/dependency-diagram.png)

![Zoom in](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/zoom-in.png)

Finding a specific dependency {#h2-8-finding-a-specific-dependency}
-------------------------------------------------------------------
...
![Find Elements in Diagram](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/find-elements.png)

![Show paths](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/show-paths.png)

![Root](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/root.png)

Focus on related nodes {#h2-9-focus-on-related-nodes}
-----------------------------------------------------
...
![Analyze Graph](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/analyze-graph.png)

![Focus View On Node Neighbourhood](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/focus-view.png)

![Drop Focus](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/drop-focus.png)

Select scopes {#h2-10-select-scopes}
------------------------------------
...
![Change Visibility Level](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/change-visibility-level.png)

![Visibility Levels](/images/posts/2023/05/analyzing-dependencies-in-intellij-idea/visibility-levels.png)

Now we know several ways to analyze our project's dependencies in IntelliJ IDEA.

IntelliJ IDEA Shortcuts Used {#h2-11-intellij-idea-shortcuts-used}
------------------------------------------------------------------
...
Related Links {#h2-12-related-links}
------------------------------------
