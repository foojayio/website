...
[![Same Time Zones application running in IntelliJ IDEA, Eclipse and NetBeans](/images/posts/2023/05/write-once-run-embedded-in-any-ide/time-zones-1024x192.png "Same application running in IntelliJ IDEA, Eclipse and NetBeans")](/images/posts/2023/05/write-once-run-embedded-in-any-ide/time-zones.png)
...
<img decoding="async" class="size-medium wp-image-66520 aligncenter" src="/images/posts/2023/05/write-once-run-embedded-in-any-ide/netbeans-monitor-700x431.png" alt="Monitoring applet running in NetBeans" width="700" height="431">
...
<img decoding="async" class="aligncenter size-medium wp-image-66522" src="/images/posts/2023/05/write-once-run-embedded-in-any-ide/eclipse-monitor-700x405.png" alt="Monitoring applet running in Eclipse IDE" width="700" height="405">

<br />

If you have JDK 18 or higher installed, you can test the monitoring by executing *jwebserver -p 8080*.

<img loading="lazy" decoding="async" class="aligncenter size-medium wp-image-66521" src="/images/posts/2023/05/write-once-run-embedded-in-any-ide/intellij-monitor-700x456.png" alt="Monitoring applet in JetBrains IntelliJ IDEA" width="700" height="456">
