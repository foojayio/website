...
![Time to first operation for Micronaut improved from 1 second without CRaC to 46 milliseconds with CRaC.](CleanShot-2023-05-15-at-08.03.52-8f6247f9.webp) **"** ***Project CRaC's checkpoint restore approach is very promising for the immediate startup of Spring applications on the JVM. Our collaboration with Azul delivered some great initial results already**.*"
> — Juergen Hoeller, project lead and co-founder of the Spring Framework project.

![Time to first operation for Spring Boot improved from 4 seconds without CRaC to 38 milliseconds with CRaC.](CleanShot-2023-05-15-at-08.04.13-702712eb.webp)
