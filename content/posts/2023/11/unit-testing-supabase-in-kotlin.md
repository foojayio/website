...
authors:
  - "jlengrand"
image: "/images/posts/2023/11/unit-testing-supabase-in-kotlin/Screenshot-2023-10-11-at-23.57.36.png"
categories:
  - "Kotlin"
  - "Testing"
tags:
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic">@Serializable
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic">create table
    public.person (
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic">class MainKtTestMock {
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic">java.lang.IllegalStateException: Plugin rest not installed or not of type Postgrest. Consider installing Postgrest within your supabase client builder
    ...
    at MainKtTestMock$setUp$1.invoke(MainKtTestMock.kt:34)</pre>
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic">class DatabaseClient(private val client: SupabaseClient){
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic">class MainKtTestSubclass {
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic">See the MainKtTestMockEngine :
...
<pre class="EnlighterJSRAW" data-enlighter-language="generic">import io.github.jan.supabase.SupabaseClient
