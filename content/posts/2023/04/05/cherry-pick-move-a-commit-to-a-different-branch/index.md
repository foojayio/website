...
authors:
  - "marit-van-dijk"
image: "GoBackToMain-1024x575-1.png"
categories:
  - "IntelliJ IDEA"
  - "Tutorials"
tags:
...
![](GoBackToMain-1024x575.png) Back on the main branch

Once we're back on the main branch, we can create a new branch named "bugfix".
![](CreateBugfixBranch-1024x575.png) Create a new Bugfix branch
...
![](SearchForHashBranchTag-1024x574.png) Search Git log for Hash/Branch/Tag

We can also filter commits in the commit log by branch, user, date or path.
![](FilterByBranchUserEtc-1024x574.png) Filter by branch, user, date or path
...
![](NotCherryPickedCommits-1024x574.png) Select the Not Cherry-Picked Commits
...
![](CommitDetails-1024x574.png) Look at the details of a commit
...
![](MergeConflict-1024x574.png) Merge Conflict

We can resolve the merge conflicts here. We want to keep some changes, and reject others.
![](MergeConflictDialog-1024x574.png) Merge Conflicts dialog ![](MergeConflictResolved-1024x574.png) Merge conflicts have been resolved
...
![](RevertCommit-1024x574.png) Revert Commit
