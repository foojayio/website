...
![Remote](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/remote.png)
...
![Open Merge Requests from logo](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/logo.png)

![Open Show GitLab Merge Requests from menu](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/menu.png)
...
![Log In](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/login.png)
...
![Generate a token](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/generate.png)

![Create Personal Access Token](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/personal-access-token.png)

![Copy the token](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/copied.png)

We can copy the token into the **Token** field in the popup and click **Log In**.

![Paste the token into the Token field](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/token.png)
...
![Add GitLab account in Settings](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/add-account.png)

![Paste the token into the Token field in Settings](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/settings-token.png)

![Account added in Settings](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/settings-account.png)

Once we're logged in, the GitLab Merge Requests tool window will show all open Merge Requests for the GitLab repository.

![GitLab Merge Requests tool window](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/mr-tool-window.png)
...
![Filter](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/filter.png)

![Search](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/search.png)

If the Merge Request has assignees and/or reviewers assigned, we can see them here.

![Assignee](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/assignee.png)

![Reviewer](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/reviewer.png)

We can see the details of a specific Merge Request by double-clicking on it.

![Merge Request details](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/mr-details.png)
...
![Open Merge Requests](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/open.png)
...
![Request Review](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/request-review.png)

![Assign reviewer](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/assign-reviewer.png)
...
![Changed files and timeline](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/changed-files.png)
...
![Checks failed](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/checks.png)
...
![Open on GitLab](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/open-on-gitlab.png)

![Open in browser](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/open-in-browser.png)

IntelliJ IDEA also shows if there are any conflicts, so we know if this request is safe to merge or not.

![Conflicts](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/conflicts.png)
...
![Show diff](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/diff.png)
...
![Navigate between files](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/navigate-between-files.png)
...
![Multiple commits](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/commits.png)
...
![Recent files](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/recent-files.png)
...
![Comment from GitLab](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/comment-from-gitlab.png)

![Refresh reviews](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/refresh-reviews.png)
...
![Comment from IntelliJ IDEA](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/comment-from-intellij-idea.png)
...
![Inline comment](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/inline-comment.png)
...
![Working with comments](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/edit.png)

From the diff viewer, we can submit our review and approve the Merge Request if we think it's ready to be merged.

![Submit Review and Approve](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/approve.png)
...
![Check out branch locally](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/checkout.png)
...
![Build success](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/build.png)
...
![Close](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/close.png)
...
![Merge](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/merge.png)

![Edit commit message](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/commit-message.png)

The Merge Request will be merged, and if we do a **Fetch** we can see the updated branches for this repository.

![Fetch](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/fetch.png)

![Updated branches](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/updated-branches.png)

We can see in our browser that the Merge Request has been closed.

![Merged](/images/posts/2023/08/working-with-gitlab-merge-requests-in-intellij-idea/merged.png)
