...
![](/images/posts/2023/08/configuring-spring-boot-to-build-a-docker-image-with-azul-zulu-and-debug-options/azul-zulu-springboot-docker-1024x400.jpg)
>
...
<figure class="wp-block-gallery has-nested-images columns-default is-cropped wp-block-gallery-1 is-layout-flex wp-block-gallery-is-layout-flex">
 <figure class="wp-block-image size-large">
  <a href="/images/posts/2023/08/configuring-spring-boot-to-build-a-docker-image-with-azul-zulu-and-debug-options/debug-config.png" target="_blank" rel="noopener"><img decoding="async" width="1024" height="663" data-id="102024" src="/images/posts/2023/08/configuring-spring-boot-to-build-a-docker-image-with-azul-zulu-and-debug-options/debug-config-1024x663.png" alt="" class="wp-image-102024"></a>
 </figure>
 <figure class="wp-block-image size-large">
  <a href="/images/posts/2023/08/configuring-spring-boot-to-build-a-docker-image-with-azul-zulu-and-debug-options/debug-breakpoint.jpg" target="_blank" rel="noopener"><img decoding="async" width="1024" height="812" data-id="102025" src="/images/posts/2023/08/configuring-spring-boot-to-build-a-docker-image-with-azul-zulu-and-debug-options/debug-breakpoint.jpg" alt="" class="wp-image-102025"></a>
 </figure>
</figure>
...
<figure class="wp-block-gallery has-nested-images columns-default is-cropped wp-block-gallery-2 is-layout-flex wp-block-gallery-is-layout-flex">
 <figure class="wp-block-image size-large">
  <a href="/images/posts/2023/08/configuring-spring-boot-to-build-a-docker-image-with-azul-zulu-and-debug-options/springboot-jmx-config.png" target="_blank" rel="noopener"><img loading="lazy" decoding="async" width="799" height="502" data-id="102028" src="/images/posts/2023/08/configuring-spring-boot-to-build-a-docker-image-with-azul-zulu-and-debug-options/springboot-jmx-config.png" alt="" class="wp-image-102028"></a>
 </figure>
 <figure class="wp-block-image size-large">
  <a href="/images/posts/2023/08/configuring-spring-boot-to-build-a-docker-image-with-azul-zulu-and-debug-options/springboot-jmx-jfr-recording.png" target="_blank" rel="noopener"><img loading="lazy" decoding="async" width="722" height="619" data-id="102026" src="/images/posts/2023/08/configuring-spring-boot-to-build-a-docker-image-with-azul-zulu-and-debug-options/springboot-jmx-jfr-recording.png" alt="" class="wp-image-102026"></a>
 </figure>
 <figure class="wp-block-image size-large">
  <a href="/images/posts/2023/08/configuring-spring-boot-to-build-a-docker-image-with-azul-zulu-and-debug-options/springboot-jmx-result.png" target="_blank" rel="noopener"><img loading="lazy" decoding="async" width="1024" height="662" data-id="102027" src="/images/posts/2023/08/configuring-spring-boot-to-build-a-docker-image-with-azul-zulu-and-debug-options/springboot-jmx-result-1024x662.png" alt="" class="wp-image-102027"></a>
 </figure>
</figure>
