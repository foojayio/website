...
![Screenshot of Gradle Enterprise test failures dashboard](flaky-test-remediation-approach-2-700x304.png)
...
![Screenshot of the time taken to run the test over time](flaky-test-remediation-approach-5-700x365.png)
...
![Screenshot of results of integration test running](flaky-test-remediation-approach-3-700x129.png)
...
![Screenshot of a test failure probably caused by two tests using the same resources](flaky-test-remediation-approach-4-700x340.png)
