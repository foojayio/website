...
![Dependabot Dependencies graph](Dependabot-Dependencies-Graph.png)  
...
![Dependabot security update](Dependabot-security-update.png)
...
![Install Renovate](Renovate-install.png)
...
![Renovate What to Expect](Renovate-What-to-expect.png)

![Renovate basic configuration](Renovate-Basic-Config.png)
...
![Renovate project Dashboard](Renovate-project-Dashboard.png)  
...
![Snyk Open Source pull request](Snyk-PR.png)  
...
![Snyk Open Source combined PR](Snyk-combined-PR.png)  
