...
AsyncGetCallTrace and GetStackTrace {#h2-0-asyncgetcalltrace-and-getstacktrace}
-------------------------------------------------------------------------------
...
Weakening the correctness definition {#h2-2-weakening-the-correctness-definition}
---------------------------------------------------------------------------------
...
Layered oracle {#h2-3-layered-oracle}
-------------------------------------
...
Ground layer {#h2-4-ground-layer}
---------------------------------
...
GetStackTrace layer {#h2-5-getstacktrace-layer}
-----------------------------------------------
...
Safe point AsyncGetCallTrace layer {#h2-6-safe-point-asyncgetcalltrace-layer}
-----------------------------------------------------------------------------
...
Async AsyncGetCallTrace layer {#h2-7-async-asyncgetcalltrace-layer}
-------------------------------------------------------------------
...
A variant of the Async AsyncGetCallTrace check {#h2-8-a-variant-of-the-async-asyncgetcalltrace-check}
-----------------------------------------------------------------------------------------------------
