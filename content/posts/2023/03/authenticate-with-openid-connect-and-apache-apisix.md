...
<img fetchpriority="high" decoding="async" class="aligncenter size-medium wp-image-62734" src="/images/posts/2023/03/authenticate-with-openid-connect-and-apache-apisix/google-cloud-credentials-526x510.jpg" alt="" width="526" height="510">

<br />

Then, press the *+ CREATE CREDENTIALS* button in the upper menu bar.

<img decoding="async" class="aligncenter size-medium wp-image-62735" src="/images/posts/2023/03/authenticate-with-openid-connect-and-apache-apisix/google-cloud-create-credentials-700x72.jpg" alt="" width="700" height="72">

<br />

Select *OAuth Client Id* in the scrolling menu.

<img decoding="async" class="aligncenter size-medium wp-image-62736" src="/images/posts/2023/03/authenticate-with-openid-connect-and-apache-apisix/google-cloud-choose-credentials-700x447.jpg" alt="" width="700" height="447">
...
![](/images/posts/2023/03/authenticate-with-openid-connect-and-apache-apisix/google-cloud-create-oauth-client-id-626x1024.jpg)
...
![](/images/posts/2023/03/authenticate-with-openid-connect-and-apache-apisix/google-cloud-oauth-client-created-957x1024.jpg)
...
<img loading="lazy" decoding="async" class="aligncenter size-medium wp-image-62739" src="/images/posts/2023/03/authenticate-with-openid-connect-and-apache-apisix/google-auth-choose-account-457x510.jpg" alt="" width="457" height="510">
