...
<img fetchpriority="high" decoding="async" class="size-medium wp-image-65426" src="/images/posts/2023/03/getting-started-with-openapi-generators-tips-tricks/runconf-700x423.png" alt="A run configuration in IntelliJ used to run a specific generator" width="700" height="423">
...
<img decoding="async" class="size-medium wp-image-65427" src="/images/posts/2023/03/getting-started-with-openapi-generators-tips-tricks/debugshow-700x411.png" alt="A screenshot of a debug of the model, showing the content of the &quot;allModels&quot; variable" width="700" height="411">
...
<img decoding="async" class="size-medium wp-image-65428" src="/images/posts/2023/03/getting-started-with-openapi-generators-tips-tricks/mustache-410x510.png" alt="A list of many custom lambdas in the OpenAPI source code" width="410" height="510">
