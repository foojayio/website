...
What is jOOQ {#h2-0-what-is-jooq}
---------------------------------
...
Great, so why should I use it? {#h2-1-great-so-why-should-i-use-it}
-------------------------------------------------------------------
...
### 1. Type safety {#h3-2-1-type-safety}
...
### 3. Vendor agnosticity {#h3-4-3-vendor-agnosticity}
...
### 4. Dynamic SQL {#h3-5-4-dynamic-sql}
...
### 5. Everything SQL {#h3-6-5-everything-sql}
