...
Do we need Serialization? {#h2-0-do-we-need-serialization}
----------------------------------------------------------
...
JEP 290: Serialization Filtering {#h2-1-jep-290-serialization-filtering}
------------------------------------------------------------------------
...
Whitelist vs. Blacklist {#h2-2-whitelist-vs-blacklist}
------------------------------------------------------
