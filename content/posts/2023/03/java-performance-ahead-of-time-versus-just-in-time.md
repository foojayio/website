...
What is Just-In-Time? {#h2-0-what-is-just-in-time}
--------------------------------------------------
...
![](/images/posts/2023/03/java-performance-ahead-of-time-versus-just-in-time/chart-speed-optimization-level-1024x538.png) Code speed comparison during different cycles of startup of an application

What is Ahead-Of-Time? {#h2-1-what-is-ahead-of-time}
----------------------------------------------------
...
Different approaches, different performance {#h2-2-different-approaches-different-performance}
----------------------------------------------------------------------------------------------
...
Comparison of AOT and JIT compilation {#h2-3-comparison-of-aot-and-jit-compilation}
-----------------------------------------------------------------------------------
