...
authors:
  - "younes-manton"
image: "open-liberty-restore-perf-ga.png"
categories:
  - "Cloud"
  - "Microservices"
  - "Performance"
...
![A diagram showing how the checkpoint + restore model fits into a typical Open Liberty dev-build-prod pipeline.](open-liberty-crflow-700x386.jpg)
...
![A diagram showing the checkpoint + restore model as compared to the traditional build + run model.](openj9-crflow-700x508.png)
...
![A graph showing the reduction in time-to-first-response when restoring from a checkpoint as compared to conventional startup.](open-liberty-restore-perf-ga-1024x645.png)
...
### Restoring multiple instances from a single checkpoint and process ID
...
### Modifying the environment of the restored process
...
### Changing the owner of restored processes
