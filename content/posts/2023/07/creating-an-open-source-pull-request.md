...
![Fork project](/images/posts/2023/07/creating-an-open-source-pull-request/fork-project.png)

![Fork](/images/posts/2023/07/creating-an-open-source-pull-request/fork.png)
...
![Clone](/images/posts/2023/07/creating-an-open-source-pull-request/clone.png)

![Copied](/images/posts/2023/07/creating-an-open-source-pull-request/copied.png)
...
![Welcome screen](/images/posts/2023/07/creating-an-open-source-pull-request/get-from-vcs.png)
...
![Clone project](/images/posts/2023/07/creating-an-open-source-pull-request/clone-project.png)
...
![New Project from version control menu](/images/posts/2023/07/creating-an-open-source-pull-request/menu-project-vcs.png)
...
![Build the project](/images/posts/2023/07/creating-an-open-source-pull-request/build-project.png)
...
![Project tool window](/images/posts/2023/07/creating-an-open-source-pull-request/project-tool-window.png)

![Find in files](/images/posts/2023/07/creating-an-open-source-pull-request/find-in-files.png)
...
![Commit changes](/images/posts/2023/07/creating-an-open-source-pull-request/commit-window.png)

![Check the differences](/images/posts/2023/07/creating-an-open-source-pull-request/show-diff.png)

If we don't have access to the original project, we need to push our code to our fork.

![Push](/images/posts/2023/07/creating-an-open-source-pull-request/push.png)
...
![Contribute](/images/posts/2023/07/creating-an-open-source-pull-request/contribute.png)
...
![Open the pull request](/images/posts/2023/07/creating-an-open-source-pull-request/open-pr.png)

![Create pull request](/images/posts/2023/07/creating-an-open-source-pull-request/create-pr2.png)
...
![Review](/images/posts/2023/07/creating-an-open-source-pull-request/review.png)

![Checks](/images/posts/2023/07/creating-an-open-source-pull-request/checks.png)
