...
<figure class="wp-block-gallery has-nested-images columns-default is-cropped wp-block-gallery-1 is-layout-flex wp-block-gallery-is-layout-flex">
 <figure class="wp-block-image size-large">
  <img fetchpriority="high" decoding="async" width="1024" height="678" data-id="98783" src="/images/posts/2023/07/running-a-crac-java-application-on-raspberry-pi/imager-64bit-1024x678.png" alt="" class="wp-image-98783">
 </figure>
 <figure class="wp-block-image size-large">
  <img decoding="async" width="1024" height="419" data-id="98784" src="/images/posts/2023/07/running-a-crac-java-application-on-raspberry-pi/azul-download-1024x419.png" alt="" class="wp-image-98784">
 </figure>
</figure>
...
<figure class="wp-block-gallery has-nested-images columns-default is-cropped wp-block-gallery-2 is-layout-flex wp-block-gallery-is-layout-flex">
 <figure class="wp-block-image size-large">
  <img decoding="async" width="1024" height="739" data-id="98785" src="/images/posts/2023/07/running-a-crac-java-application-on-raspberry-pi/raspberrypi-os-kernel-criu-1-1024x739.png" alt="" class="wp-image-98785">
 </figure>
 <figure class="wp-block-image size-large">
  <img loading="lazy" decoding="async" width="1024" height="734" data-id="98786" src="/images/posts/2023/07/running-a-crac-java-application-on-raspberry-pi/raspberrypi-os-kernel-criu-2-1024x734.png" alt="" class="wp-image-98786">
 </figure>
</figure>
