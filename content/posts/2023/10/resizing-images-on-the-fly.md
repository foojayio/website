...
[![](/images/posts/2023/10/resizing-images-on-the-fly/imgproxy-flow-1024x479.png)](/images/posts/2023/10/resizing-images-on-the-fly/imgproxy-flow.png)The corresponding Apache APISIX configuration looks like the following:
...
We can now test the above setup with the browser's Developer Tools, emulating small screen devices, *i.e.* , iPhone SE. The result is the following: [![](/images/posts/2023/10/resizing-images-on-the-fly/test-set-up-result.png)](/images/posts/2023/10/resizing-images-on-the-fly/test-set-up-result.png)
