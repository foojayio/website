...
authors:
  - "simon-verhoeven"
image: "/images/posts/2023/10/contributing-to-open-source-hacktoberfest/hacktober.png"
categories:
  - "Events"
  - "Java Beginner"
tags:
...
* **Find Projects** : Look for projects on [GitHub](https://github.com/topics/hacktoberfest) or [GitLab](https://go.gitlab.com/ubCLKL) that are participating (tagged with the "Hacktoberfest" label) to ensure your contributions count toward the event.
...
<img fetchpriority="high" decoding="async" class="size-medium wp-image-102487 aligncenter" src="/images/posts/2023/10/contributing-to-open-source-hacktoberfest/gfi-700x227.png" alt="" width="700" height="227">
