...
![microservices level8](/images/posts/2023/02/journeys-in-java-level-8-add-mongodb-to-spring-cloud-config/microservices-level8.png)
...
![config server test 1](/images/posts/2023/02/journeys-in-java-level-8-add-mongodb-to-spring-cloud-config/config-server-test-1.png)
...
![microservices lvl8 results books](/images/posts/2023/02/journeys-in-java-level-8-add-mongodb-to-spring-cloud-config/microservices-lvl8-results-books.png)

Figure 2. Find books

![microservices lvl8 results authors](/images/posts/2023/02/journeys-in-java-level-8-add-mongodb-to-spring-cloud-config/microservices-lvl8-results-authors.png)
