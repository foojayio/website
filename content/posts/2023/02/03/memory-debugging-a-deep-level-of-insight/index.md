...
### Profiler vs. Debugger {#h3-1-profiler-vs-debugger}
...
### Searchable Memory View {#h3-2-searchable-memory-view}
...
### Update Loaded Classes {#h3-3-update-loaded-classes}
...
### Track New Instances {#h3-4-track-new-instances}
...
### Step-Over and Breakpoints {#h3-5-step-over-and-breakpoints}
